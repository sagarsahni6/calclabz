...
module.exports = {
  ...
  pythagorean: {
    ...
    howToSteps: [
      'Enter your Side A (0 to solve), Side B (0 to solve), Hypotenuse C (0 to solve) in the input fields provided',
      'Results are computed instantly as you enter or modify values — no need to click a button',
      'Review the computed output showing your pythagorean theorem results with a detailed breakdown',
      'Use the output for preliminary design checks — critical applications require verification by a licensed professional'
    ],
    methodology: 'This calculator computes pythagorean theorem values using standard engineering reference formulas (IS/IEEE/ASME). Results are preliminary estimates suitable for coursework and early-stage design checks. All critical applications must be verified by a licensed professional engineer.',
    faqs: [
  ...
  ohmslaw: {
    ...
    howToSteps: [
      'Enter your Voltage (V) — 0 to solve, Current (I) — 0 to solve, Resistance (R) — 0 to solve in the input fields provided',
      'Results are computed instantly as you enter or modify values — no need to click a button',
      'Review the computed output showing your ohm\'s law results with a detailed breakdown',
      'Use the output for preliminary design checks — critical applications require verification by a licensed professional'
    ],
    methodology: 'This calculator computes ohm\'s law values using standard engineering reference formulas (IS/IEEE/ASME). Results are preliminary estimates suitable for coursework and early-stage design checks. All critical applications must be verified by a licensed professional engineer.',
    faqs: [
  ...
  resistor: {
    ...
    howToSteps: [
      'Enter your Band 1, Band 2, Multiplier, and other required values in the input fields',
      'Results are computed instantly as you enter or modify values — no need to click a button',
      'Review the computed output showing your resistor results with a detailed breakdown',
      'Use the output for preliminary design checks — critical applications require verification by a licensed professional'
    ],
    methodology: 'This calculator computes resistor values using standard engineering reference formulas (IS/IEEE/ASME). Results are preliminary estimates suitable for coursework and early-stage design checks. All critical applications must be verified by a licensed professional engineer.',
    faqs: [
  ...
  power: {
    ...
    howToSteps: [
      'Enter your Power, Voltage in the input fields provided',
      'Results are computed instantly as you enter or modify values — no need to click a button',
      'Review the computed output showing your power results with a detailed breakdown',
      'Use the output for preliminary design checks — critical applications require verification by a licensed professional'
    ],
    methodology: 'This calculator computes power values using standard engineering reference formulas (IS/IEEE/ASME). Results are preliminary estimates suitable for coursework and early-stage design checks. All critical applications must be verified by a licensed professional engineer.',
    faqs: [
  ...
  inverterbattery: {
    ...
    howToSteps: [
      'Enter your Total Load (appliances), Backup Hours Needed, Battery Voltage, and other required values in the input fields',
      'Results are computed instantly as you enter or modify values — no need to click a button',
      'Review the computed output showing your inverter battery results with a detailed breakdown',
      'Use the output for preliminary design checks — critical applications require verification by a licensed professional'
    ],
    methodology: 'This calculator computes inverter battery values using standard engineering reference formulas (IS/IEEE/ASME). Results are preliminary estimates suitable for coursework and early-stage design checks. All critical applications must be verified by a licensed professional engineer.',
    faqs: [
  ...
  acbtu: {
    ...
    howToSteps: [
      'Enter your Room Length, Room Width, Ceiling Height, and other required values in the input fields',
      'Results are computed instantly as you enter or modify values — no need to click a button',
      'Review the computed output showing your ac btu results with a detailed breakdown',
      'Use the output for preliminary design checks — critical applications require verification by a licensed professional'
    ],
    methodology: 'This calculator computes ac btu values using standard engineering reference formulas (IS/IEEE/ASME). Results are preliminary estimates suitable for coursework and early-stage design checks. All critical applications must be verified by a licensed professional engineer.',
    faqs: [
  ...
  beamload: {
    ...
    howToSteps: [
      'Enter your Beam Span (Length), Load Type, Total Load, and other required values in the input fields',
      'Results are computed instantly as you enter or modify values — no need to click a button',
      'Review the computed output showing your beam load results with a detailed breakdown',
      'Use the output for preliminary design checks — critical applications require verification by a licensed professional'
    ],
    methodology: 'This calculator computes beam load values using standard engineering reference formulas (IS/IEEE/ASME). Results are preliminary estimates suitable for coursework and early-stage design checks. All critical applications must be verified by a licensed professional engineer.',
    faqs: [
  ...
  pipeflow: {
    ...
    howToSteps: [
      'Enter your Pipe Inner Diameter, Pipe Length, Flow Rate, and other required values in the input fields',
      'Results are computed instantly as you enter or modify values — no need to click a button',
      'Review the computed output showing your pipe flow results with a detailed breakdown',
      'Use the output for preliminary design checks — critical applications require verification by a licensed professional'
    ],
    methodology: 'This calculator computes pipe flow values using standard engineering reference formulas (IS/IEEE/ASME). Results are preliminary estimates suitable for coursework and early-stage design checks. All critical applications must be verified by a licensed professional engineer.',
    faqs: [
  ...
  threephase: {
    ...
    howToSteps: [
      'Enter your Line Voltage, Line Current, Power Factor, and other required values in the input fields',
      'Results are computed instantly as you enter or modify values — no need to click a button',
      'Review the computed output showing your three phase power results with a detailed breakdown',
      'Use the output for preliminary design checks — critical applications require verification by a licensed professional'
    ],
    methodology: 'This calculator computes three phase power values using standard engineering reference formulas (IS/IEEE/ASME). Results are preliminary estimates suitable for coursework and early-stage design checks. All critical applications must be verified by a licensed professional engineer.',
    faqs: [
  ...
  transformercalc: {
    ...
    howToSteps: [
      'Enter your Primary Voltage, Secondary Voltage, Power Rating, and other required values in the input fields',
      'Results are computed instantly as you enter or modify values — no need to click a button',
      'Review the computed output showing your transformer results with a detailed breakdown',
      'Use the output for preliminary design checks — critical applications require verification by a licensed professional'
    ],
    methodology: 'This calculator computes transformer values using standard engineering reference formulas (IS/IEEE/ASME). Results are preliminary estimates suitable for coursework and early-stage design checks. All critical applications must be verified by a licensed professional engineer.',
    faqs: [
  ...
  heatexchanger: {
    ...
    howToSteps: [
      'Enter your Mass Flow Rate, Specific Heat (Cp), Hot Inlet Temp, and other required values in the input fields',
      'Results are computed instantly as you enter or modify values — no need to click a button',
      'Review the computed output showing your heat exchanger results with a detailed breakdown',
      'Use the output for preliminary design checks — critical applications require verification by a licensed professional'
    ],
    methodology: 'This calculator computes heat exchanger values using standard engineering reference formulas (IS/IEEE/ASME). Results are preliminary estimates suitable for coursework and early-stage design checks. All critical applications must be verified by a licensed professional engineer.',
    faqs: [
  ...
  fluidflow: {
    ...
    howToSteps: [
      'Enter your Pipe Inner Diameter, Pipe Length, Flow Rate, and other required values in the input fields',
      'Results are computed instantly as you enter or modify values — no need to click a button',
      'Review the computed output showing your fluid flow results with a detailed breakdown',
      'Use the output for preliminary design checks — critical applications require verification by a licensed professional'
    ],
    methodology: 'This calculator computes fluid flow values using standard engineering reference formulas (IS/IEEE/ASME). Results are preliminary estimates suitable for coursework and early-stage design checks. All critical applications must be verified by a licensed professional engineer.',
    faqs: [
  ...
  springforce: {
    ...
    howToSteps: [
      'Enter your Spring Constant (k), Displacement (x), Attached Mass in the input fields provided',
      'Results are computed instantly as you enter or modify values — no need to click a button',
      'Review the computed output showing your spring force results with a detailed breakdown',
      'Use the output for preliminary design checks — critical applications require verification by a licensed professional'
    ],
    methodology: 'This calculator computes spring force values using standard engineering reference formulas (IS/IEEE/ASME). Results are preliminary estimates suitable for coursework and early-stage design checks. All critical applications must be verified by a licensed professional engineer.',
    faqs: [
  ...
  gearratio: {
    ...
    howToSteps: [
      'Enter your Driving Gear Teeth, Driven Gear Teeth, Input RPM, and other required values in the input fields',
      'Results are computed instantly as you enter or modify values — no need to click a button',
      'Review the computed output showing your gear ratio results with a detailed breakdown',
      'Use the output for preliminary design checks — critical applications require verification by a licensed professional'
    ],
    methodology: 'This calculator computes gear ratio values using standard engineering reference formulas (IS/IEEE/ASME). Results are preliminary estimates suitable for coursework and early-stage design checks. All critical applications must be verified by a licensed professional engineer.',
    faqs: [
  ...
  torque: {
    ...
    howToSteps: [
      'Enter your Force, Moment Arm Length, Angle between F and arm in the input fields provided',
      'Results are computed instantly as you enter or modify values — no need to click a button',
      'Review the computed output showing your torque results with a detailed breakdown',
      'Use the output for preliminary design checks — critical applications require verification by a licensed professional'
    ],
    methodology: 'This calculator uses the formula: τ = F × r × sin(θ). Where τ = Torque (N·m) ; F = Force (N) ; r = Moment arm (m) ; θ = Angle. Maximum torque when force is perpendicular (θ=90°). Power = τ × angular velocity. All calculations run entirely in your browser — no data is transmitted to any server.',
    faqs: [
  ...
  decibel: {
    ...
    howToSteps: [
      'Enter your Decibel Value, Reference Type in the input fields provided',
      'Results are computed instantly as you enter or modify values — no need to click a button',
      'Review the computed output showing your decibel results with a detailed breakdown',
      'Use the output for preliminary design checks — critical applications require verification by a licensed professional'
    ],
    methodology: 'This calculator uses the formula: dB (power) = 10 × log₁₀(P₂/P₁) | dB (voltage) = 20 × log₁₀(V₂/V₁). Where +3dB ≈ 2× power ; +6dB ≈ 2× voltage ; 0 dBm = 1 milliwatt. Decibels are logarithmic ratios. Used for sound, signal power, and gain measurement. All calculations run entirely in your browser — no data is transmitted to any server.',
    faqs: [
  ...
  antennalen: {
    ...
    howToSteps: [
      'Enter your Frequency, Velocity Factor in the input fields provided',
      'Results are computed instantly as you enter or modify values — no need to click a button',
      'Review the computed output showing your antenna length results with a detailed breakdown',
      'Use the output for preliminary design checks — critical applications require verification by a licensed professional'
    ],
    methodology: 'This calculator uses the formula: λ = c / f | Half-wave dipole = λ/2 | Quarter-wave = λ/4. Where c = 299,792,458 m/s ; f = Frequency (Hz) ; Velocity factor = 0.66–1.0. Antenna length is fraction of wavelength. Velocity factor accounts for wire vs free-space speed. All calculations run entirely in your browser — no data is transmitted to any server.',
    faqs: [
  ...
  ledresistor: {
    ...
    howToSteps: [
      'Enter your Supply Voltage, LED Forward Voltage, LED Forward Current in the input fields provided',
      'Results are computed instantly as you enter or modify values — no need to click a button',
      'Review the computed output showing your led resistor results with a detailed breakdown',
      'Use the output for preliminary design checks — critical applications require verification by a licensed professional'
    ],
    methodology: 'This calculator uses the formula: R = (V_supply − V_LED) / I_LED. Where V_LED: Red≈1.8V, Green≈2.2V, Blue/White≈3.2V ; I_LED: typically 20mA. Ohm\'s law applied to LED circuits. Always use a resistor to limit current through LEDs. All calculations run entirely in your browser — no data is transmitted to any server.',
    faqs: [
  ...
  voltdivider: {
    ...
    howToSteps: [
      'Enter your Input Voltage (Vin), R1 (top resistor), R2 (bottom resistor) in the input fields provided',
      'Results are computed instantly as you enter or modify values — no need to click a button',
      'Review the computed output showing your voltage divider results with a detailed breakdown',
      'Use the output for preliminary design checks — critical applications require verification by a licensed professional'
    ],
    methodology: 'This calculator uses the formula: V_out = V_in × R₂ / (R₁ + R₂). Where R₁ = Top resistor ; R₂ = Bottom resistor ; I = V_in / (R₁+R₂). Voltage divider reduces voltage proportionally. Output depends on ratio, not absolute values. All calculations run entirely in your browser — no data is transmitted to any server.',
    faqs: [
  ...
  batterylife: {
    ...
    howToSteps: [
      'Enter your Battery Capacity, Device Current Draw, Circuit Efficiency in the input fields provided',
      'Results are computed instantly as you enter or modify values — no need to click a button',
      'Review the computed output showing your battery life results with a detailed breakdown',
      'Use the output for preliminary design checks — critical applications require verification by a licensed professional'
    ],
    methodology: 'This calculator uses the formula: Hours = (Capacity_mAh × Efficiency%) / Current_draw_mA. Where LiPo nominal voltage = 3.7V ; Energy = Capacity × Voltage. Actual battery life is always less than theoretical due to efficiency losses and aging. All calculations run entirely in your browser — no data is transmitted to any server.',
    faqs: [
  ...
  pcbtrace: {
    ...
    howToSteps: [
      'Enter your Maximum Current, Allowable Temp Rise, Copper Thickness, and other required values in the input fields',
      'Results are computed instantly as you enter or modify values — no need to click a button',
      'Review the computed output showing your pcb trace width results with a detailed breakdown',
      'Use the output for preliminary design checks — critical applications require verification by a licensed professional'
    ],
    methodology: 'This calculator uses the formula: Area = (I / (k × ΔT^0.44))^(1/0.725) mils². Where k = 0.048 (external) or 0.024 (internal) ; Width = Area / Thickness. IPC-2221 standard. Always add 50% safety margin. Use thicker copper for high-current traces. All calculations run entirely in your browser — no data is transmitted to any server.',
    faqs: [
  ...
  newtons: {
    ...
    howToSteps: [
      'Enter your Mass, Acceleration, Velocity in the input fields provided',
      'Results are computed instantly as you enter or modify values — no need to click a button',
      'Review the computed output showing your newton\'s laws results with a detailed breakdown',
      'Verify the result against your textbook or lab data and note the units used in the output'
    ],
    methodology: 'This calculator uses the formula: F = m × a | KE = ½mv² | p = m × v. Where F = Force (N) ; m = Mass (kg) ; a = Acceleration (m/s²) ; v = Velocity (m/s). Newton\'s Second Law. Weight = mass × gravity. Momentum is conserved in collisions. All calculations run entirely in your browser — no data is transmitted to any server.',
    faqs: [
  ...
  density: {
    ...
    howToSteps: [
      'Enter your Mass (0 to solve), Volume (0 to solve), Density (0 to solve) in the input fields provided',
      'Results are computed instantly as you enter or modify values — no need to click a button',
      'Review the computed output showing your density results with a detailed breakdown',
      'Verify the result against your textbook or lab data and note the units used in the output'
    ],
    methodology: 'This calculator uses the formula: ρ = m / V | m = ρ × V | V = m / ρ. Where ρ = Density (g/cm³ or kg/m³) ; m = Mass ; V = Volume ; Water ρ = 1 g/cm³. Objects with density < 1 g/cm³ float in water. Convert: 1 g/cm³ = 1000 kg/m³. All calculations run entirely in your browser — no data is transmitted to any server.',
    faqs: [
  ...
  wavelength: {
    ...
    howToSteps: [
      'Enter your Wave Speed, Frequency in the input fields provided',
      'Results are computed instantly as you enter or modify values — no need to click a button',
      'Review the computed output showing your wavelength results with a detailed breakdown',
      'Verify the result against your textbook or lab data and note the units used in the output'
    ],
    methodology: 'This calculator uses the formula: λ = v / f | T = 1 / f | E = h × f. Where λ = Wavelength ; v = Wave speed ; f = Frequency ; T = Period ; h = Planck\'s constant. Wave speed = wavelength × frequency. For light in vacuum, v = 3×10⁸ m/s. For sound at 20°C, v ≈ 343 m/s. All calculations run entirely in your browser — no data is transmitted to any server.',
    faqs: [
  ...
  gravitational: {
    ...
    howToSteps: [
      'Enter your Mass 1, Mass 2, Distance in the input fields provided',
      'Results are computed instantly as you enter or modify values — no need to click a button',
      'Review the computed output showing your gravitational force results with a detailed breakdown',
      'Verify the result against your textbook or lab data and note the units used in the output'
    ],
    methodology: 'This calculator uses the formula: F = G × m₁ × m₂ / r². Where G = 6.674×10⁻¹¹ N·m²/kg² ; m₁,m₂ = Masses ; r = Distance between centers. Newton\'s law of universal gravitation. Escape velocity = √(2GM/r). All calculations run entirely in your browser — no data is transmitted to any server.',
    faqs: [
  ...
  halflife: {
    ...
    howToSteps: [
      'Enter your Initial Quantity, Half-Life, Elapsed Time in the input fields provided',
      'Results are computed instantly as you enter or modify values — no need to click a button',
      'Review the computed output showing your half-life results with a detailed breakdown',
      'Verify the result against your textbook or lab data and note the units used in the output'
    ],
    methodology: 'This calculator uses the formula: N(t) = N₀ × (½)^(t/t½). Where N₀ = Initial quantity ; t = Elapsed time ; t½ = Half-life period. After each half-life, exactly half the radioactive atoms remain. Carbon-14 t½ = 5,730 years. All calculations run entirely in your browser — no data is transmitted to any server.',
    faqs: [
  ...
  ph: {
    ...
    howToSteps: [
      'Enter your H⁺ Concentration (mol/L), Temperature in the input fields provided',
      'Results are computed instantly as you enter or modify values — no need to click a button',
      'Review the computed output showing your ph results with a detailed breakdown',
      'Verify the result against your textbook or lab data and note the units used in the output'
    ],
    methodology: 'This calculator uses the formula: pH = −log₁₀[H⁺] | pOH = 14 − pH. Where [H⁺] = Hydrogen ion concentration (mol/L) ; pH 7 = Neutral. pH scale: 0–14. Each unit = 10× change in H⁺ concentration. pH < 7 = acid, > 7 = base. All calculations run entirely in your browser — no data is transmitted to any server.',
    faqs: [
  ...
  thermodynamics: {
    ...
    howToSteps: [
      'Enter your Initial Pressure P₁, Initial Volume V₁, Initial Temp T₁, and other required values in the input fields',
      'Results are computed instantly as you enter or modify values — no need to click a button',
      'Review the computed output showing your thermodynamics results with a detailed breakdown',
      'Verify the result against your textbook or lab data and note the units used in the output'
    ],
    methodology: 'This calculator uses the formula: PV = nRT | Boyle: P₁V₁ = P₂V₂ | Charles: V₁/T₁ = V₂/T₂. Where P = Pressure ; V = Volume ; n = Moles ; R = 0.0821 L·atm/mol·K ; T = Temperature (K). Ideal gas law relates pressure, volume, temperature and amount. R is the universal gas constant. All calculations run entirely in your browser — no data is transmitted to any server.',
    faqs: [
  ...
  acceleration: {
    ...
    howToSteps: [
      'Enter your Initial Velocity (u), Final Velocity (v), Time taken (t) in the input fields provided',
      'Results are computed instantly as you enter or modify values — no need to click a button',
      'Review the computed output showing your acceleration results with a detailed breakdown',
      'Verify the result against your textbook or lab data and note the units used in the output'
    ],
    methodology: 'This calculator uses the formula: a = (v − u) / t | s = ut + ½at². Where a = Acceleration (m/s²) ; G-force = a / 9.81 ; 1g = 9.81 m/s². Negative acceleration = deceleration. G-force measures acceleration relative to gravity. All calculations run entirely in your browser — no data is transmitted to any server.',
    faqs: [
