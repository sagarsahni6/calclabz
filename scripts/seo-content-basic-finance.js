...
module.exports = {
  salaryhike: {
    ...
    howToSteps: [
      ...
      'Review the detailed breakdown showing your salary hike results with charts and tables'
    ],
    methodology: 'This calculator uses standard financial formulas widely used in Indian banking and investment industries. Inputs are processed using established mathematical models for salary hike computation. Results account for applicable rates, compounding, and time-value-of-money principles where relevant. All calculations run locally in your browser — no data is sent to any server.',
    faqs: [
  ...
  roi: {
    ...
    howToSteps: [
      ...
      'Adjust optional parameters like tax rate, inflation, or compounding frequency if available',
      'Click Calculate or view results updating in real time as you type',
      'Review the detailed breakdown showing your roi results with charts and tables'
    ],
    methodology: 'This calculator uses standard financial formulas widely used in Indian banking and investment industries. Inputs are processed using established mathematical models for roi computation. Results account for applicable rates, compounding, and time-value-of-money principles where relevant. All calculations run locally in your browser — no data is sent to any server.',
    faqs: [
  ...
  prepayment: {
    ...
    howToSteps: [
      ...
      'Adjust optional parameters like tax rate, inflation, or compounding frequency if available',
      'Click Calculate or view results updating in real time as you type',
      'Review the detailed breakdown showing your loan prepayment results with charts and tables'
    ],
    methodology: 'This calculator uses standard financial formulas widely used in Indian banking and investment industries. Inputs are processed using established mathematical models for loan prepayment computation. Results account for applicable rates, compounding, and time-value-of-money principles where relevant. All calculations run locally in your browser — no data is sent to any server.',
    faqs: [
  ...
  savingsgoal: {
    ...
    howToSteps: [
      ...
      'Adjust optional parameters like tax rate, inflation, or compounding frequency if available',
      'Click Calculate or view results updating in real time as you type',
      'Review the detailed breakdown showing your savings goal results with charts and tables'
    ],
    methodology: 'This calculator uses standard financial formulas widely used in Indian banking and investment industries. Inputs are processed using established mathematical models for savings goal computation. Results account for applicable rates, compounding, and time-value-of-money principles where relevant. All calculations run locally in your browser — no data is sent to any server.',
    faqs: [
  ...
  goalsip: {
    ...
    howToSteps: [
      ...
      'Adjust optional parameters like tax rate, inflation, or compounding frequency if available',
      'Click Calculate or view results updating in real time as you type',
      'Review the detailed breakdown showing your goal-based sip results with charts and tables'
    ],
    methodology: 'This calculator uses standard financial formulas widely used in Indian banking and investment industries. Inputs are processed using established mathematical models for goal-based sip computation. Results account for applicable rates, compounding, and time-value-of-money principles where relevant. All calculations run locally in your browser — no data is sent to any server.',
    faqs: [
  ...
  taxsaving: {
    ...
    howToSteps: [
      ...
      'Adjust optional parameters like tax rate, inflation, or compounding frequency if available',
      'Click Calculate or view results updating in real time as you type',
      'Review the detailed breakdown showing your tax saving results with charts and tables'
    ],
    methodology: 'This calculator uses standard financial formulas widely used in Indian banking and investment industries. Inputs are processed using established mathematical models for tax saving computation. Results account for applicable rates, compounding, and time-value-of-money principles where relevant. All calculations run locally in your browser — no data is sent to any server.',
    faqs: [
  ...
  advancetax: {
    ...
    howToSteps: [
      ...
      'Adjust optional parameters like tax rate, inflation, or compounding frequency if available',
      'Click Calculate or view results updating in real time as you type',
      'Review the detailed breakdown showing your advance tax results with charts and tables'
    ],
    methodology: 'This calculator uses standard financial formulas widely used in Indian banking and investment industries. Inputs are processed using established mathematical models for advance tax computation. Results account for applicable rates, compounding, and time-value-of-money principles where relevant. All calculations run locally in your browser — no data is sent to any server.',
    faqs: [
  ...
  ctcbreakup: {
    ...
    howToSteps: [
      ...
      'Adjust optional parameters like tax rate, inflation, or compounding frequency if available',
      'Click Calculate or view results updating in real time as you type',
      'Review the detailed breakdown showing your ctc breakup results with charts and tables'
    ],
    methodology: 'This calculator uses standard financial formulas widely used in Indian banking and investment industries. Inputs are processed using established mathematical models for ctc breakup computation. Results account for applicable rates, compounding, and time-value-of-money principles where relevant. All calculations run locally in your browser — no data is sent to any server.',
    faqs: [
  ...
  fire: {
    ...
    howToSteps: [
      ...
      'Adjust optional parameters like tax rate, inflation, or compounding frequency if available',
      'Click Calculate or view results updating in real time as you type',
      'Review the detailed breakdown showing your fire results with charts and tables'
    ],
    methodology: 'This calculator uses standard financial formulas widely used in Indian banking and investment industries. Inputs are processed using established mathematical models for fire computation. Results account for applicable rates, compounding, and time-value-of-money principles where relevant. All calculations run locally in your browser — no data is sent to any server.',
    faqs: [
  ...
  debtavalanche: {
    ...
    howToSteps: [
      ...
      'Adjust optional parameters like tax rate, inflation, or compounding frequency if available',
      'Click Calculate or view results updating in real time as you type',
      'Review the detailed breakdown showing your debt avalanche results with charts and tables'
    ],
    methodology: 'This calculator uses standard financial formulas widely used in Indian banking and investment industries. Inputs are processed using established mathematical models for debt avalanche computation. Results account for applicable rates, compounding, and time-value-of-money principles where relevant. All calculations run locally in your browser — no data is sent to any server.',
    faqs: [
  ...
  emergencyfund: {
    ...
    howToSteps: [
      ...
      'Adjust optional parameters like tax rate, inflation, or compounding frequency if available',
      'Click Calculate or view results updating in real time as you type',
      'Review the detailed breakdown showing your emergency fund results with charts and tables'
    ],
    methodology: 'This calculator uses standard financial formulas widely used in Indian banking and investment industries. Inputs are processed using established mathematical models for emergency fund computation. Results account for applicable rates, compounding, and time-value-of-money principles where relevant. All calculations run locally in your browser — no data is sent to any server.',
    faqs: [
  ...
  rentvsbuy: {
    ...
    howToSteps: [
      ...
      'Adjust optional parameters like tax rate, inflation, or compounding frequency if available',
      'Click Calculate or view results updating in real time as you type',
      'Review the detailed breakdown showing your rent vs buy results with charts and tables'
    ],
    methodology: 'This calculator uses standard financial formulas widely used in Indian banking and investment industries. Inputs are processed using established mathematical models for rent vs buy computation. Results account for applicable rates, compounding, and time-value-of-money principles where relevant. All calculations run locally in your browser — no data is sent to any server.',
    faqs: [
  ...
  carleasevsbuy: {
    ...
    howToSteps: [
      ...
      'Adjust optional parameters like tax rate, inflation, or compounding frequency if available',
      'Click Calculate or view results updating in real time as you type',
      'Review the detailed breakdown showing your car lease vs buy results with charts and tables'
    ],
    methodology: 'This calculator uses standard financial formulas widely used in Indian banking and investment industries. Inputs are processed using established mathematical models for car lease vs buy computation. Results account for applicable rates, compounding, and time-value-of-money principles where relevant. All calculations run locally in your browser — no data is sent to any server.',
    faqs: [
  ...
  homedownpayment: {
    ...
    howToSteps: [
      ...
      'Adjust optional parameters like tax rate, inflation, or compounding frequency if available',
      'Click Calculate or view results updating in real time as you type',
      'Review the detailed breakdown showing your home down payment results with charts and tables'
    ],
    methodology: 'This calculator uses standard financial formulas widely used in Indian banking and investment industries. Inputs are processed using established mathematical models for home down payment computation. Results account for applicable rates, compounding, and time-value-of-money principles where relevant. All calculations run locally in your browser — no data is sent to any server.',
    faqs: [
  ...
  loancompare: {
    ...
    howToSteps: [
      ...
      'Adjust optional parameters like tax rate, inflation, or compounding frequency if available',
      'Click Calculate or view results updating in real time as you type',
      'Review the detailed breakdown showing your loan comparison results with charts and tables'
    ],
    methodology: 'This calculator uses standard financial formulas widely used in Indian banking and investment industries. Inputs are processed using established mathematical models for loan comparison computation. Results account for applicable rates, compounding, and time-value-of-money principles where relevant. All calculations run locally in your browser — no data is sent to any server.',
    faqs: [
  ...
  refinance: {
    ...
    howToSteps: [
      ...
      'Adjust optional parameters like tax rate, inflation, or compounding frequency if available',
      'Click Calculate or view results updating in real time as you type',
      'Review the detailed breakdown showing your loan refinance results with charts and tables'
    ],
    methodology: 'This calculator uses standard financial formulas widely used in Indian banking and investment industries. Inputs are processed using established mathematical models for loan refinance computation. Results account for applicable rates, compounding, and time-value-of-money principles where relevant. All calculations run locally in your browser — no data is sent to any server.',
    faqs: [
  ...
  creditutil: {
    ...
    howToSteps: [
      ...
      'Adjust optional parameters like tax rate, inflation, or compounding frequency if available',
      'Click Calculate or view results updating in real time as you type',
      'Review the detailed breakdown showing your credit utilization results with charts and tables'
    ],
    methodology: 'This calculator uses standard financial formulas widely used in Indian banking and investment industries. Inputs are processed using established mathematical models for credit utilization computation. Results account for applicable rates, compounding, and time-value-of-money principles where relevant. All calculations run locally in your browser — no data is sent to any server.',
    faqs: [
  ...
  insuranceneed: {
    ...
    howToSteps: [
      ...
      'Adjust optional parameters like tax rate, inflation, or compounding frequency if available',
      'Click Calculate or view results updating in real time as you type',
      'Review the detailed breakdown showing your insurance need results with charts and tables'
    ],
    methodology: 'This calculator uses standard financial formulas widely used in Indian banking and investment industries. Inputs are processed using established mathematical models for insurance need computation. Results account for applicable rates, compounding, and time-value-of-money principles where relevant. All calculations run locally in your browser — no data is sent to any server.',
    faqs: [
  ...
  npvirr: {
    ...
    howToSteps: [
      ...
      'Adjust optional parameters like tax rate, inflation, or compounding frequency if available',
      'Click Calculate or view results updating in real time as you type',
      'Review the detailed breakdown showing your npv & irr results with charts and tables'
    ],
    methodology: 'This calculator uses standard financial formulas widely used in Indian banking and investment industries. Inputs are processed using established mathematical models for npv & irr computation. Results account for applicable rates, compounding, and time-value-of-money principles where relevant. All calculations run locally in your browser — no data is sent to any server.',
    faqs: [
  ...
  bondyield: {
    ...
    howToSteps: [
      ...
      'Adjust optional parameters like tax rate, inflation, or compounding frequency if available',
      'Click Calculate or view results updating in real time as you type',
      'Review the detailed breakdown showing your bond yield results with charts and tables'
    ],
    methodology: 'This calculator uses standard financial formulas widely used in Indian banking and investment industries. Inputs are processed using established mathematical models for bond yield computation. Results account for applicable rates, compounding, and time-value-of-money principles where relevant. All calculations run locally in your browser — no data is sent to any server.',
    faqs: [
  ...
  optionprofit: {
    ...
    howToSteps: [
      ...
      'Adjust optional parameters like tax rate, inflation, or compounding frequency if available',
      'Click Calculate or view results updating in real time as you type',
      'Review the detailed breakdown showing your options profit results with charts and tables'
    ],
    methodology: 'This calculator uses standard financial formulas widely used in Indian banking and investment industries. Inputs are processed using established mathematical models for options profit computation. Results account for applicable rates, compounding, and time-value-of-money principles where relevant. All calculations run locally in your browser — no data is sent to any server.',
    faqs: [
  ...
  forexpip: {
    ...
    howToSteps: [
      ...
      'Adjust optional parameters like tax rate, inflation, or compounding frequency if available',
      'Click Calculate or view results updating in real time as you type',
      'Review the detailed breakdown showing your forex pip results with charts and tables'
    ],
    methodology: 'This calculator uses standard financial formulas widely used in Indian banking and investment industries. Inputs are processed using established mathematical models for forex pip computation. Results account for applicable rates, compounding, and time-value-of-money principles where relevant. All calculations run locally in your browser — no data is sent to any server.',
    faqs: [
  ...
  portfoliorebalance: {
    ...
    howToSteps: [
      ...
      'Adjust optional parameters like tax rate, inflation, or compounding frequency if available',
      'Click Calculate or view results updating in real time as you type',
      'Review the detailed breakdown showing your portfolio rebalance results with charts and tables'
    ],
    methodology: 'This calculator uses standard financial formulas widely used in Indian banking and investment industries. Inputs are processed using established mathematical models for portfolio rebalance computation. Results account for applicable rates, compounding, and time-value-of-money principles where relevant. All calculations run locally in your browser — no data is sent to any server.',
    faqs: [
  ...
  assetallocation: {
    ...
    howToSteps: [
      ...
      'Adjust optional parameters like tax rate, inflation, or compounding frequency if available',
      'Click Calculate or view results updating in real time as you type',
      'Review the detailed breakdown showing your asset allocation results with charts and tables'
    ],
    methodology: 'This calculator uses standard financial formulas widely used in Indian banking and investment industries. Inputs are processed using established mathematical models for asset allocation computation. Results account for applicable rates, compounding, and time-value-of-money principles where relevant. All calculations run locally in your browser — no data is sent to any server.',
    faqs: [
  ...
  montecarlo: {
    ...
    howToSteps: [
      ...
      'Adjust optional parameters like tax rate, inflation, or compounding frequency if available',
      'Click Calculate or view results updating in real time as you type',
      'Review the detailed breakdown showing your monte carlo simulator results with charts and tables'
    ],
    methodology: 'This calculator uses standard financial formulas widely used in Indian banking and investment industries. Inputs are processed using established mathematical models for monte carlo simulator computation. Results account for applicable rates, compounding, and time-value-of-money principles where relevant. All calculations run locally in your browser — no data is sent to any server.',
    faqs: [
  ...
  inflationgoal: {
    ...
    howToSteps: [
      ...
      'Adjust optional parameters like tax rate, inflation, or compounding frequency if available',
      'Click Calculate or view results updating in real time as you type',
      'Review the detailed breakdown showing your inflation-adjusted goal results with charts and tables'
    ],
    methodology: 'This calculator uses standard financial formulas widely used in Indian banking and investment industries. Inputs are processed using established mathematical models for inflation-adjusted goal computation. Results account for applicable rates, compounding, and time-value-of-money principles where relevant. All calculations run locally in your browser — no data is sent to any server.',
    faqs: [
  ...
  businessloan: {
    ...
    howToSteps: [
      ...
      'Adjust optional parameters like tax rate, inflation, or compounding frequency if available',
      'Click Calculate or view results updating in real time as you type',
      'Review the detailed breakdown showing your business loan results with charts and tables'
    ],
    methodology: 'This calculator uses standard financial formulas widely used in Indian banking and investment industries. Inputs are processed using established mathematical models for business loan computation. Results account for applicable rates, compounding, and time-value-of-money principles where relevant. All calculations run locally in your browser — no data is sent to any server.',
    faqs: [
  ...
  gstinvoice: {
    ...
    howToSteps: [
      ...
      'Adjust optional parameters like tax rate, inflation, or compounding frequency if available',
      'Click Calculate or view results updating in real time as you type',
      'Review the detailed breakdown showing your gst invoice generator results with charts and tables'
    ],
    methodology: 'This calculator uses standard financial formulas widely used in Indian banking and investment industries. Inputs are processed using established mathematical models for gst invoice generator computation. Results account for applicable rates, compounding, and time-value-of-money principles where relevant. All calculations run locally in your browser — no data is sent to any server.',
    faqs: [
  ...
  esoptax: {
    ...
    howToSteps: [
      ...
      'Adjust optional parameters like tax rate, inflation, or compounding frequency if available',
      'Click Calculate or view results updating in real time as you type',
      'Review the detailed breakdown showing your esop tax results with charts and tables'
    ],
    methodology: 'This calculator uses standard financial formulas widely used in Indian banking and investment industries. Inputs are processed using established mathematical models for esop tax computation. Results account for applicable rates, compounding, and time-value-of-money principles where relevant. All calculations run locally in your browser — no data is sent to any server.',
    faqs: [
  ...
  freelancetax: {
    ...
    howToSteps: [
      ...
      'Adjust optional parameters like tax rate, inflation, or compounding frequency if available',
      'Click Calculate or view results updating in real time as you type',
      'Review the detailed breakdown showing your freelancer tax results with charts and tables'
    ],
    methodology: 'This calculator uses standard financial formulas widely used in Indian banking and investment industries. Inputs are processed using established mathematical models for freelancer tax computation. Results account for applicable rates, compounding, and time-value-of-money principles where relevant. All calculations run locally in your browser — no data is sent to any server.',
    faqs: [
  ...
  tcsremittance: {
    ...
    howToSteps: [
      ...
      'Adjust optional parameters like tax rate, inflation, or compounding frequency if available',
      'Click Calculate or view results updating in real time as you type',
      'Review the detailed breakdown showing your tcs on remittance results with charts and tables'
    ],
    methodology: 'This calculator uses standard financial formulas widely used in Indian banking and investment industries. Inputs are processed using established mathematical models for tcs on remittance computation. Results account for applicable rates, compounding, and time-value-of-money principles where relevant. All calculations run locally in your browser — no data is sent to any server.',
    faqs: [
  ...
  sec80c: {
    ...
    howToSteps: [
      ...
      'Adjust optional parameters like tax rate, inflation, or compounding frequency if available',
      'Click Calculate or view results updating in real time as you type',
      'Review the detailed breakdown showing your section 80c results with charts and tables'
    ],
    methodology: 'This calculator uses standard financial formulas widely used in Indian banking and investment industries. Inputs are processed using established mathematical models for section 80c computation. Results account for applicable rates, compounding, and time-value-of-money principles where relevant. All calculations run locally in your browser — no data is sent to any server.',
    faqs: [
  ...
  hravshomeloan: {
    ...
    howToSteps: [
      ...
      'Adjust optional parameters like tax rate, inflation, or compounding frequency if available',
      'Click Calculate or view results updating in real time as you type',
      'Review the detailed breakdown showing your hra vs home loan results with charts and tables'
    ],
    methodology: 'This calculator uses standard financial formulas widely used in Indian banking and investment industries. Inputs are processed using established mathematical models for hra vs home loan computation. Results account for applicable rates, compounding, and time-value-of-money principles where relevant. All calculations run locally in your browser — no data is sent to any server.',
    faqs: [
  ...
  leaveencash: {
    ...
    howToSteps: [
      ...
      'Adjust optional parameters like tax rate, inflation, or compounding frequency if available',
      'Click Calculate or view results updating in real time as you type',
      'Review the detailed breakdown showing your leave encashment results with charts and tables'
    ],
    methodology: 'This calculator uses standard financial formulas widely used in Indian banking and investment industries. Inputs are processed using established mathematical models for leave encashment computation. Results account for applicable rates, compounding, and time-value-of-money principles where relevant. All calculations run locally in your browser — no data is sent to any server.',
    faqs: [
  ...
  breakeven: {
    ...
    howToSteps: [
      ...
      'Adjust optional parameters like tax rate, inflation, or compounding frequency if available',
      'Click Calculate or view results updating in real time as you type',
      'Review the detailed breakdown showing your break-even results with charts and tables'
    ],
    methodology: 'This calculator uses standard financial formulas widely used in Indian banking and investment industries. Inputs are processed using established mathematical models for break-even computation. Results account for applicable rates, compounding, and time-value-of-money principles where relevant. All calculations run locally in your browser — no data is sent to any server.',
    faqs: [
  ...
  networth: {
    ...
    howToSteps: [
      ...
      'Adjust optional parameters like tax rate, inflation, or compounding frequency if available',
      'Click Calculate or view results updating in real time as you type',
      'Review the detailed breakdown showing your net worth results with charts and tables'
    ],
    methodology: 'This calculator uses standard financial formulas widely used in Indian banking and investment industries. Inputs are processed using established mathematical models for net worth computation. Results account for applicable rates, compounding, and time-value-of-money principles where relevant. All calculations run locally in your browser — no data is sent to any server.',
    faqs: [
  ...
  dividendyield: {
    ...
    howToSteps: [
      ...
      'Adjust optional parameters like tax rate, inflation, or compounding frequency if available',
      'Click Calculate or view results updating in real time as you type',
      'Review the detailed breakdown showing your dividend yield results with charts and tables'
    ],
    methodology: 'This calculator uses standard financial formulas widely used in Indian banking and investment industries. Inputs are processed using established mathematical models for dividend yield computation. Results account for applicable rates, compounding, and time-value-of-money principles where relevant. All calculations run locally in your browser — no data is sent to any server.',
    faqs: [
  ...
  goldinvestment: {
    ...
    howToSteps: [
      ...
      'Adjust optional parameters like tax rate, inflation, or compounding frequency if available',
      'Click Calculate or view results updating in real time as you type',
      'Review the detailed breakdown showing your gold investment results with charts and tables'
    ],
    methodology: 'This calculator uses standard financial formulas widely used in Indian banking and investment industries. Inputs are processed using established mathematical models for gold investment computation. Results account for applicable rates, compounding, and time-value-of-money principles where relevant. All calculations run locally in your browser — no data is sent to any server.',
    faqs: [
  ...
  profitloss: {
    ...
    howToSteps: [
      ...
      'Adjust optional parameters like tax rate, inflation, or compounding frequency if available',
      'Click Calculate or view results updating in real time as you type',
      'Review the detailed breakdown showing your profit & loss results with charts and tables'
    ],
    methodology: 'This calculator uses standard financial formulas widely used in Indian banking and investment industries. Inputs are processed using established mathematical models for profit & loss computation. Results account for applicable rates, compounding, and time-value-of-money principles where relevant. All calculations run locally in your browser — no data is sent to any server.',
    faqs: [
  ...
  stockreturn: {
    ...
    howToSteps: [
      ...
      'Adjust optional parameters like tax rate, inflation, or compounding frequency if available',
      'Click Calculate or view results updating in real time as you type',
      'Review the detailed breakdown showing your stock return results with charts and tables'
    ],
    methodology: 'This calculator uses standard financial formulas widely used in Indian banking and investment industries. Inputs are processed using established mathematical models for stock return computation. Results account for applicable rates, compounding, and time-value-of-money principles where relevant. All calculations run locally in your browser — no data is sent to any server.',
    faqs: [
  ...
  mutualfundreturns: {
    ...
    howToSteps: [
      ...
      'Adjust optional parameters like tax rate, inflation, or compounding frequency if available',
      'Click Calculate or view results updating in real time as you type',
      'Review the detailed breakdown showing your mutual fund returns results with charts and tables'
    ],
    methodology: 'This calculator uses standard financial formulas widely used in Indian banking and investment industries. Inputs are processed using established mathematical models for mutual fund returns computation. Results account for applicable rates, compounding, and time-value-of-money principles where relevant. All calculations run locally in your browser — no data is sent to any server.',
    faqs: [
  ...
  xirr: {
    ...
    howToSteps: [
      ...
      'Adjust optional parameters like tax rate, inflation, or compounding frequency if available',
      'Click Calculate or view results updating in real time as you type',
      'Review the detailed breakdown showing your xirr results with charts and tables'
    ],
    methodology: 'This calculator uses standard financial formulas widely used in Indian banking and investment industries. Inputs are processed using established mathematical models for xirr computation. Results account for applicable rates, compounding, and time-value-of-money principles where relevant. All calculations run locally in your browser — no data is sent to any server.',
    faqs: [
  ...
  balancetransfer: {
    ...
    howToSteps: [
      ...
      'Adjust optional parameters like tax rate, inflation, or compounding frequency if available',
      'Click Calculate or view results updating in real time as you type',
      'Review the detailed breakdown showing your balance transfer results with charts and tables'
    ],
    methodology: 'This calculator uses standard financial formulas widely used in Indian banking and investment industries. Inputs are processed using established mathematical models for balance transfer computation. Results account for applicable rates, compounding, and time-value-of-money principles where relevant. All calculations run locally in your browser — no data is sent to any server.',
    faqs: [
  ...
  scss: {
    ...
    howToSteps: [
      ...
      'Adjust optional parameters like tax rate, inflation, or compounding frequency if available',
      'Click Calculate or view results updating in real time as you type',
      'Review the detailed breakdown showing your senior citizen savings results with charts and tables'
    ],
    methodology: 'This calculator uses standard financial formulas widely used in Indian banking and investment industries. Inputs are processed using established mathematical models for senior citizen savings computation. Results account for applicable rates, compounding, and time-value-of-money principles where relevant. All calculations run locally in your browser — no data is sent to any server.',
    faqs: [
  ...
  elssreturns: {
    ...
    howToSteps: [
      ...
      'Adjust optional parameters like tax rate, inflation, or compounding frequency if available',
      'Click Calculate or view results updating in real time as you type',
      'Review the detailed breakdown showing your elss returns results with charts and tables'
    ],
    methodology: 'This calculator uses standard financial formulas widely used in Indian banking and investment industries. Inputs are processed using established mathematical models for elss returns computation. Results account for applicable rates, compounding, and time-value-of-money principles where relevant. All calculations run locally in your browser — no data is sent to any server.',
    faqs: [
  ...
  nsc: {
    ...
    howToSteps: [
      ...
      'Adjust optional parameters like tax rate, inflation, or compounding frequency if available',
      'Click Calculate or view results updating in real time as you type',
      'Review the detailed breakdown showing your nsc results with charts and tables'
    ],
    methodology: 'This calculator uses standard financial formulas widely used in Indian banking and investment industries. Inputs are processed using established mathematical models for nsc computation. Results account for applicable rates, compounding, and time-value-of-money principles where relevant. All calculations run locally in your browser — no data is sent to any server.',
    faqs: [
  ...
  apy: {
    ...
    howToSteps: [
      ...
      'Adjust optional parameters like tax rate, inflation, or compounding frequency if available',
      'Click Calculate or view results updating in real time as you type',
      'Review the detailed breakdown showing your apy results with charts and tables'
    ],
    methodology: 'This calculator uses standard financial formulas widely used in Indian banking and investment industries. Inputs are processed using established mathematical models for apy computation. Results account for applicable rates, compounding, and time-value-of-money principles where relevant. All calculations run locally in your browser — no data is sent to any server.',
    faqs: [
  ...
  brokerage: {
    ...
    howToSteps: [
      ...
      'Adjust optional parameters like tax rate, inflation, or compounding frequency if available',
      'Click Calculate or view results updating in real time as you type',
      'Review the detailed breakdown showing your brokerage results with charts and tables'
    ],
    methodology: 'This calculator uses standard financial formulas widely used in Indian banking and investment industries. Inputs are processed using established mathematical models for brokerage computation. Results account for applicable rates, compounding, and time-value-of-money principles where relevant. All calculations run locally in your browser — no data is sent to any server.',
    faqs: [
  ...
  salarycomparison: {
    ...
    howToSteps: [
      ...
      'Adjust optional parameters like tax rate, inflation, or compounding frequency if available',
      'Click Calculate or view results updating in real time as you type',
      'Review the detailed breakdown showing your salary comparison results with charts and tables'
    ],
    methodology: 'This calculator uses standard financial formulas widely used in Indian banking and investment industries. Inputs are processed using established mathematical models for salary comparison computation. Results account for applicable rates, compounding, and time-value-of-money principles where relevant. All calculations run locally in your browser — no data is sent to any server.',
    faqs: [
