...
module.exports = {
  salaryhike: {
    ...
    howToSteps: [
      'Enter your Current Monthly Salary, Hike Percentage, Current Annual CTC, and other required values in the input fields',
      'Results are computed instantly as you enter or modify values — no need to click a button',
      'Review the computed output showing your salary hike results with a detailed breakdown',
      'Use the results to compare financial scenarios, plan budgets, or verify lender and investment calculations'
    ],
    methodology: 'This calculator applies standard salary hike formulas used across Indian banking and financial planning. Inputs are validated and processed using established mathematical models. Results include applicable rates and compounding where relevant. All processing happens locally in your browser — no financial data leaves your device.',
    faqs: [
  ...
  pregst: {
    ...
    methodology: 'The base price is calculated using the formula: Pre-GST Price = GST-Inclusive Price ÷ (1 + GST Rate/100). For example, at 18% GST, the divisor is 1.18. The GST amount is then split equally into CGST and SGST for intra-state transactions, or shown as IGST for inter-state.',
    howToSteps: [
      'Enter the total GST-inclusive amount (the price you paid or see on the bill)',
      'Select the applicable GST slab — 5%, 12%, 18%, or 28%',
      'View the base price before GST, the GST amount, and the CGST/SGST split',
      'Use the result for invoice verification, input tax credit claims, or price comparison'
    ],
    faqs: [
  ...
  roi: {
    ...
    howToSteps: [
      'Enter your Initial Investment, Current Value, Period in the input fields provided',
      'Results are computed instantly as you enter or modify values — no need to click a button',
      'Review the computed output showing your roi results with a detailed breakdown',
      'Use the results to compare financial scenarios, plan budgets, or verify lender and investment calculations'
    ],
    methodology: 'This calculator applies standard roi formulas used across Indian banking and financial planning. Inputs are validated and processed using established mathematical models. Results include applicable rates and compounding where relevant. All processing happens locally in your browser — no financial data leaves your device.',
    faqs: [
  ...
  prepayment: {
    ...
    howToSteps: [
      'Enter your Outstanding Principal, Interest Rate, Remaining Tenure, and other required values in the input fields',
      'Results are computed instantly as you enter or modify values — no need to click a button',
      'Review the computed output showing your loan prepayment results with a detailed breakdown',
      'Use the results to compare financial scenarios, plan budgets, or verify lender and investment calculations'
    ],
    methodology: 'This calculator uses the formula: Interest Saved = Total Interest (before) − Total Interest (after prepayment). Where New Principal = Outstanding − Lump Sum ; EMI remains same, tenure reduces. Lump-sum prepayment reduces principal, saving significant interest over remaining tenure. All calculations run entirely in your browser — no data is transmitted to any server.',
    faqs: [
  ...
  savingsgoal: {
    ...
    howToSteps: [
      'Enter your Target Amount, Current Savings, Expected Return, and other required values in the input fields',
      'Results are computed instantly as you enter or modify values — no need to click a button',
      'Review the computed output showing your savings goal results with a detailed breakdown',
      'Use the results to compare financial scenarios, plan budgets, or verify lender and investment calculations'
    ],
    methodology: 'This calculator uses the formula: Monthly = (Goal − Current×(1+r)ⁿ) × r / ((1+r)ⁿ − 1). Where Goal = Target amount ; Current = Existing savings ; r = Monthly rate ; n = Months. Calculates the monthly savings needed after accounting for growth of existing savings. All calculations run entirely in your browser — no data is transmitted to any server.',
    faqs: [
  ...
  goalsip: {
    ...
    howToSteps: [
      'Enter your Target Amount, Time Horizon, Expected Return, and other required values in the input fields',
      'Results are computed instantly as you enter or modify values — no need to click a button',
      'Review the computed output showing your goal-based sip results with a detailed breakdown',
      'Use the results to compare financial scenarios, plan budgets, or verify lender and investment calculations'
    ],
    methodology: 'This calculator uses the formula: SIP = (Goal − Existing×(1+r)ⁿ) × r / ((1+r)ⁿ−1) / (1+r). Where Goal = Target amount ; r = Monthly return ; n = months ; Existing = Current corpus. Calculates exact monthly SIP needed, accounting for existing investments growing over time. All calculations run entirely in your browser — no data is transmitted to any server.',
    faqs: [
  ...
  taxsaving: {
    ...
    howToSteps: [
      'Enter your Taxable Income, EPF (Employee), PPF, and other required values in the input fields',
      'Results are computed instantly as you enter or modify values — no need to click a button',
      'Review the computed output showing your tax saving results with a detailed breakdown',
      'Use the results to compare financial scenarios, plan budgets, or verify lender and investment calculations'
    ],
    methodology: 'This calculator uses the formula: Tax Saved = (80C + 80CCD + 80D + 24B) × Tax Slab Rate. Where 80C max ₹1.5L ; 80CCD(1B) max ₹50K ; 80D max ₹75K ; 24B max ₹2L. Optimize deductions to minimize tax. Fill 80C first, then NPS for extra ₹50K deduction. All calculations run entirely in your browser — no data is transmitted to any server.',
    faqs: [
  ...
  advancetax: {
    ...
    howToSteps: [
      'Enter your Total Annual Income, TDS Already Deducted, Tax Regime, and other required values in the input fields',
      'Results are computed instantly as you enter or modify values — no need to click a button',
      'Review the computed output showing your advance tax results with a detailed breakdown',
      'Use the results to compare financial scenarios, plan budgets, or verify lender and investment calculations'
    ],
    methodology: 'This calculator uses the formula: Advance Tax = Total Tax − TDS | Paid in 4 installments (15%, 45%, 75%, 100%). Where Q1: Jun 15 (15%) ; Q2: Sep 15 (45%) ; Q3: Dec 15 (75%) ; Q4: Mar 15 (100%). Required if total tax liability exceeds ₹10,000. Interest u/s 234C for late payment. All calculations run entirely in your browser — no data is transmitted to any server.',
    faqs: [
  ...
  ctcbreakup: {
    ...
    howToSteps: [
      'Enter your Annual CTC, Basic %, HRA %, and other required values in the input fields',
      'Results are computed instantly as you enter or modify values — no need to click a button',
      'Review the computed output showing your ctc breakup results with a detailed breakdown',
      'Use the results to compare financial scenarios, plan budgets, or verify lender and investment calculations'
    ],
    methodology: 'This calculator uses the formula: Monthly In-Hand = (CTC − Bonus − Gratuity − PF_Er − Insurance) / 12 − PF_Emp − PT. Where Gratuity = Basic × 15/26 ; PF_Er = min(Basic, 15000×12) × 12%. CTC includes all employer costs. Actual in-hand is significantly lower after all deductions. All calculations run entirely in your browser — no data is transmitted to any server.',
    faqs: [
  ...
  fire: {
    ...
    howToSteps: [
      'Enter your Annual Living Expenses, Current Portfolio Value, Annual Savings, and other required values in the input fields',
      'Results are computed instantly as you enter or modify values — no need to click a button',
      'Review the computed output showing your fire results with a detailed breakdown',
      'Use the results to compare financial scenarios, plan budgets, or verify lender and investment calculations'
    ],
    methodology: 'This calculator applies standard fire formulas used across Indian banking and financial planning. Inputs are validated and processed using established mathematical models. Results include applicable rates and compounding where relevant. All processing happens locally in your browser — no financial data leaves your device.',
    faqs: [
  ...
  debtavalanche: {
    ...
    howToSteps: [
      'Enter your Debt 1 Balance, Debt 1 Rate, Debt 1 Min Payment, and other required values in the input fields',
      'Results are computed instantly as you enter or modify values — no need to click a button',
      'Review the computed output showing your debt avalanche results with a detailed breakdown',
      'Use the results to compare financial scenarios, plan budgets, or verify lender and investment calculations'
    ],
    methodology: 'This calculator applies standard debt avalanche formulas used across Indian banking and financial planning. Inputs are validated and processed using established mathematical models. Results include applicable rates and compounding where relevant. All processing happens locally in your browser — no financial data leaves your device.',
    faqs: [
  ...
  emergencyfund: {
    ...
    howToSteps: [
      'Enter your Monthly Living Expenses, Months of Cover, Current Emergency Fund, and other required values in the input fields',
      'Results are computed instantly as you enter or modify values — no need to click a button',
      'Review the computed output showing your emergency fund results with a detailed breakdown',
      'Use the results to compare financial scenarios, plan budgets, or verify lender and investment calculations'
    ],
    methodology: 'This calculator applies standard emergency fund formulas used across Indian banking and financial planning. Inputs are validated and processed using established mathematical models. Results include applicable rates and compounding where relevant. All processing happens locally in your browser — no financial data leaves your device.',
    faqs: [
  ...
  rentvsbuy: {
    ...
    howToSteps: [
      'Enter your Home Purchase Price, Down Payment, Home Loan Rate, and other required values in the input fields',
      'Results are computed instantly as you enter or modify values — no need to click a button',
      'Review the computed output showing your rent vs buy results with a detailed breakdown',
      'Use the results to compare financial scenarios, plan budgets, or verify lender and investment calculations'
    ],
    methodology: 'This calculator applies standard rent vs buy formulas used across Indian banking and financial planning. Inputs are validated and processed using established mathematical models. Results include applicable rates and compounding where relevant. All processing happens locally in your browser — no financial data leaves your device.',
    faqs: [
  ...
  carleasevsbuy: {
    ...
    howToSteps: [
      'Enter your Car On-Road Price, Down Payment (if buying), Car Loan Rate, and other required values in the input fields',
      'Results are computed instantly as you enter or modify values — no need to click a button',
      'Review the computed output showing your car lease vs buy results with a detailed breakdown',
      'Use the results to compare financial scenarios, plan budgets, or verify lender and investment calculations'
    ],
    methodology: 'This calculator applies standard car lease vs buy formulas used across Indian banking and financial planning. Inputs are validated and processed using established mathematical models. Results include applicable rates and compounding where relevant. All processing happens locally in your browser — no financial data leaves your device.',
    faqs: [
  ...
  homedownpayment: {
    ...
    howToSteps: [
      'Enter your Target Home Price, Down Payment %, Currently Saved, and other required values in the input fields',
      'Results are computed instantly as you enter or modify values — no need to click a button',
      'Review the computed output showing your home down payment results with a detailed breakdown',
      'Use the results to compare financial scenarios, plan budgets, or verify lender and investment calculations'
    ],
    methodology: 'This calculator applies standard home down payment formulas used across Indian banking and financial planning. Inputs are validated and processed using established mathematical models. Results include applicable rates and compounding where relevant. All processing happens locally in your browser — no financial data leaves your device.',
    faqs: [
  ...
  loancompare: {
    ...
    howToSteps: [
      'Enter your Loan Amount, Bank 1 Rate, Bank 1 Tenure, and other required values in the input fields',
      'Results are computed instantly as you enter or modify values — no need to click a button',
      'Review the computed output showing your loan comparison results with a detailed breakdown',
      'Use the results to compare financial scenarios, plan budgets, or verify lender and investment calculations'
    ],
    methodology: 'This calculator applies standard loan comparison formulas used across Indian banking and financial planning. Inputs are validated and processed using established mathematical models. Results include applicable rates and compounding where relevant. All processing happens locally in your browser — no financial data leaves your device.',
    faqs: [
  ...
  refinance: {
    ...
    howToSteps: [
      'Enter your Outstanding Balance, Current Interest Rate, Remaining Months, and other required values in the input fields',
      'Results are computed instantly as you enter or modify values — no need to click a button',
      'Review the computed output showing your loan refinance results with a detailed breakdown',
      'Use the results to compare financial scenarios, plan budgets, or verify lender and investment calculations'
    ],
    methodology: 'This calculator applies standard loan refinance formulas used across Indian banking and financial planning. Inputs are validated and processed using established mathematical models. Results include applicable rates and compounding where relevant. All processing happens locally in your browser — no financial data leaves your device.',
    faqs: [
  ...
  creditutil: {
    ...
    howToSteps: [
      'Enter your Card 1 Credit Limit, Card 1 Current Balance, Card 2 Limit (0=skip), and other required values in the input fields',
      'Results are computed instantly as you enter or modify values — no need to click a button',
      'Review the computed output showing your credit utilization results with a detailed breakdown',
      'Use the results to compare financial scenarios, plan budgets, or verify lender and investment calculations'
    ],
    methodology: 'This calculator applies standard credit utilization formulas used across Indian banking and financial planning. Inputs are validated and processed using established mathematical models. Results include applicable rates and compounding where relevant. All processing happens locally in your browser — no financial data leaves your device.',
    faqs: [
  ...
  insuranceneed: {
    ...
    howToSteps: [
      'Enter your Annual Income, Income Years to Replace, Outstanding Loans, and other required values in the input fields',
      'Results are computed instantly as you enter or modify values — no need to click a button',
      'Review the computed output showing your insurance need results with a detailed breakdown',
      'Use the results to compare financial scenarios, plan budgets, or verify lender and investment calculations'
    ],
    methodology: 'This calculator applies standard insurance need formulas used across Indian banking and financial planning. Inputs are validated and processed using established mathematical models. Results include applicable rates and compounding where relevant. All processing happens locally in your browser — no financial data leaves your device.',
    faqs: [
  ...
  npvirr: {
    ...
    howToSteps: [
      'Enter your Initial Investment, Year 1 Cash Flow, Year 2 Cash Flow, and other required values in the input fields',
      'Results are computed instantly as you enter or modify values — no need to click a button',
      'Review the computed output showing your npv & irr results with a detailed breakdown',
      'Use the results to compare financial scenarios, plan budgets, or verify lender and investment calculations'
    ],
    methodology: 'This calculator applies standard npv & irr formulas used across Indian banking and financial planning. Inputs are validated and processed using established mathematical models. Results include applicable rates and compounding where relevant. All processing happens locally in your browser — no financial data leaves your device.',
    faqs: [
  ...
  bondyield: {
    ...
    howToSteps: [
      'Enter your Face Value (Par), Coupon Rate, Market Price, and other required values in the input fields',
      'Results are computed instantly as you enter or modify values — no need to click a button',
      'Review the computed output showing your bond yield results with a detailed breakdown',
      'Use the results to compare financial scenarios, plan budgets, or verify lender and investment calculations'
    ],
    methodology: 'This calculator applies standard bond yield formulas used across Indian banking and financial planning. Inputs are validated and processed using established mathematical models. Results include applicable rates and compounding where relevant. All processing happens locally in your browser — no financial data leaves your device.',
    faqs: [
  ...
  optionprofit: {
    ...
    howToSteps: [
      'Enter your Option Type, Current Spot Price, Strike Price, and other required values in the input fields',
      'Results are computed instantly as you enter or modify values — no need to click a button',
      'Review the computed output showing your options profit results with a detailed breakdown',
      'Use the results to compare financial scenarios, plan budgets, or verify lender and investment calculations'
    ],
    methodology: 'This calculator applies standard options profit formulas used across Indian banking and financial planning. Inputs are validated and processed using established mathematical models. Results include applicable rates and compounding where relevant. All processing happens locally in your browser — no financial data leaves your device.',
    faqs: [
  ...
  forexpip: {
    ...
    howToSteps: [
      'Enter your Currency Pair, Account Balance, Risk per Trade, and other required values in the input fields',
      'Results are computed instantly as you enter or modify values — no need to click a button',
      'Review the computed output showing your forex pip results with a detailed breakdown',
      'Use the results to compare financial scenarios, plan budgets, or verify lender and investment calculations'
    ],
    methodology: 'This calculator applies standard forex pip formulas used across Indian banking and financial planning. Inputs are validated and processed using established mathematical models. Results include applicable rates and compounding where relevant. All processing happens locally in your browser — no financial data leaves your device.',
    faqs: [
  ...
  portfoliorebalance: {
    ...
    howToSteps: [
      'Enter your Total Portfolio Value, Current Equity %, Current Debt %, and other required values in the input fields',
      'Results are computed instantly as you enter or modify values — no need to click a button',
      'Review the computed output showing your portfolio rebalance results with a detailed breakdown',
      'Use the results to compare financial scenarios, plan budgets, or verify lender and investment calculations'
    ],
    methodology: 'This calculator applies standard portfolio rebalance formulas used across Indian banking and financial planning. Inputs are validated and processed using established mathematical models. Results include applicable rates and compounding where relevant. All processing happens locally in your browser — no financial data leaves your device.',
    faqs: [
  ...
  assetallocation: {
    ...
    howToSteps: [
      'Enter your Your Age, Risk Profile, Target Corpus, and other required values in the input fields',
      'Results are computed instantly as you enter or modify values — no need to click a button',
      'Review the computed output showing your asset allocation results with a detailed breakdown',
      'Use the results to compare financial scenarios, plan budgets, or verify lender and investment calculations'
    ],
    methodology: 'This calculator applies standard asset allocation formulas used across Indian banking and financial planning. Inputs are validated and processed using established mathematical models. Results include applicable rates and compounding where relevant. All processing happens locally in your browser — no financial data leaves your device.',
    faqs: [
  ...
  montecarlo: {
    ...
    howToSteps: [
      'Enter your Retirement Corpus, Annual Withdrawal, Years in Retirement, and other required values in the input fields',
      'Results are computed instantly as you enter or modify values — no need to click a button',
      'Review the computed output showing your monte carlo simulator results with a detailed breakdown',
      'Use the results to compare financial scenarios, plan budgets, or verify lender and investment calculations'
    ],
    methodology: 'This calculator applies standard monte carlo simulator formulas used across Indian banking and financial planning. Inputs are validated and processed using established mathematical models. Results include applicable rates and compounding where relevant. All processing happens locally in your browser — no financial data leaves your device.',
    faqs: [
  ...
  inflationgoal: {
    ...
    methodology: 'This calculator applies standard inflation-adjusted goal formulas used across Indian banking and financial planning. Inputs are validated and processed using established mathematical models. Results include applicable rates and compounding where relevant. All processing happens locally in your browser — no financial data leaves your device.',
    faqs: [
  ...
  businessloan: {
    ...
    howToSteps: [
      'Enter your Loan Amount, Interest Rate, Tenure, and other required values in the input fields',
      'Results are computed instantly as you enter or modify values — no need to click a button',
      'Review the computed output showing your business loan results with a detailed breakdown',
      'Use the results to compare financial scenarios, plan budgets, or verify lender and investment calculations'
    ],
    methodology: 'This calculator applies standard business loan formulas used across Indian banking and financial planning. Inputs are validated and processed using established mathematical models. Results include applicable rates and compounding where relevant. All processing happens locally in your browser — no financial data leaves your device.',
    faqs: [
  ...
  gstinvoice: {
    ...
    howToSteps: [
      'Enter your Cost / Purchase Price, Selling Price (excl. GST), GST Rate, and other required values in the input fields',
      'Results are computed instantly as you enter or modify values — no need to click a button',
      'Review the computed output showing your gst invoice results with a detailed breakdown',
      'Use the results to compare financial scenarios, plan budgets, or verify lender and investment calculations'
    ],
    methodology: 'This calculator applies standard gst invoice formulas used across Indian banking and financial planning. Inputs are validated and processed using established mathematical models. Results include applicable rates and compounding where relevant. All processing happens locally in your browser — no financial data leaves your device.',
    faqs: [
  ...
  esoptax: {
    ...
    howToSteps: [
      'Enter your Grant / Exercise Price, FMV on Exercise Date, Sale Price, and other required values in the input fields',
      'Results are computed instantly as you enter or modify values — no need to click a button',
      'Review the computed output showing your esop tax results with a detailed breakdown',
      'Use the results to compare financial scenarios, plan budgets, or verify lender and investment calculations'
    ],
    methodology: 'This calculator applies standard esop tax formulas used across Indian banking and financial planning. Inputs are validated and processed using established mathematical models. Results include applicable rates and compounding where relevant. All processing happens locally in your browser — no financial data leaves your device.',
    faqs: [
  ...
  freelancetax: {
    ...
    howToSteps: [
      'Enter your Annual Gross Revenue, Business Expenses, 80C Investments, and other required values in the input fields',
      'Results are computed instantly as you enter or modify values — no need to click a button',
      'Review the computed output showing your freelancer tax results with a detailed breakdown',
      'Use the results to compare financial scenarios, plan budgets, or verify lender and investment calculations'
    ],
    methodology: 'This calculator applies standard freelancer tax formulas used across Indian banking and financial planning. Inputs are validated and processed using established mathematical models. Results include applicable rates and compounding where relevant. All processing happens locally in your browser — no financial data leaves your device.',
    faqs: [
  ...
  tcsremittance: {
    ...
    howToSteps: [
      'Enter your Remittance Amount, Purpose, Total LRS Used This FY in the input fields provided',
      'Results are computed instantly as you enter or modify values — no need to click a button',
      'Review the computed output showing your tcs on remittance results with a detailed breakdown',
      'Use the results to compare financial scenarios, plan budgets, or verify lender and investment calculations'
    ],
    methodology: 'This calculator applies standard tcs on remittance formulas used across Indian banking and financial planning. Inputs are validated and processed using established mathematical models. Results include applicable rates and compounding where relevant. All processing happens locally in your browser — no financial data leaves your device.',
    faqs: [
  ...
  sec80c: {
    ...
    howToSteps: [
      'Enter your EPF (Employee PF), PPF, ELSS Mutual Funds, and other required values in the input fields',
      'Results are computed instantly as you enter or modify values — no need to click a button',
      'Review the computed output showing your section 80c results with a detailed breakdown',
      'Use the results to compare financial scenarios, plan budgets, or verify lender and investment calculations'
    ],
    methodology: 'This calculator applies standard section 80c formulas used across Indian banking and financial planning. Inputs are validated and processed using established mathematical models. Results include applicable rates and compounding where relevant. All processing happens locally in your browser — no financial data leaves your device.',
    faqs: [
  ...
  hravshomeloan: {
    ...
    howToSteps: [
      'Enter your Monthly Basic Salary, Monthly HRA Received, Monthly Rent Paid, and other required values in the input fields',
      'Results are computed instantly as you enter or modify values — no need to click a button',
      'Review the computed output showing your hra vs home loan results with a detailed breakdown',
      'Use the results to compare financial scenarios, plan budgets, or verify lender and investment calculations'
    ],
    methodology: 'This calculator applies standard hra vs home loan formulas used across Indian banking and financial planning. Inputs are validated and processed using established mathematical models. Results include applicable rates and compounding where relevant. All processing happens locally in your browser — no financial data leaves your device.',
    faqs: [
  ...
  leaveencash: {
    ...
    howToSteps: [
      'Enter your Last Drawn Basic Salary, Leave Balance, Years of Service, and other required values in the input fields',
      'Results are computed instantly as you enter or modify values — no need to click a button',
      'Review the computed output showing your leave encashment results with a detailed breakdown',
      'Use the results to compare financial scenarios, plan budgets, or verify lender and investment calculations'
    ],
    methodology: 'This calculator applies standard leave encashment formulas used across Indian banking and financial planning. Inputs are validated and processed using established mathematical models. Results include applicable rates and compounding where relevant. All processing happens locally in your browser — no financial data leaves your device.',
    faqs: [
  ...
  breakeven: {
    ...
    howToSteps: [
      'Enter your Fixed Costs, Selling Price/Unit, Variable Cost/Unit in the input fields provided',
      'Results are computed instantly as you enter or modify values — no need to click a button',
      'Review the computed output showing your break-even results with a detailed breakdown',
      'Use the results to compare financial scenarios, plan budgets, or verify lender and investment calculations'
    ],
    methodology: 'This calculator applies standard break-even formulas used across Indian banking and financial planning. Inputs are validated and processed using established mathematical models. Results include applicable rates and compounding where relevant. All processing happens locally in your browser — no financial data leaves your device.',
    faqs: [
  ...
  networth: {
    ...
    howToSteps: [
      'Enter your Cash & Bank Balance, Stocks & Mutual Funds, Property Value, and other required values in the input fields',
      'Results are computed instantly as you enter or modify values — no need to click a button',
      'Review the computed output showing your net worth results with a detailed breakdown',
      'Use the results to compare financial scenarios, plan budgets, or verify lender and investment calculations'
    ],
    methodology: 'This calculator uses the formula: Net Worth = Total Assets − Total Liabilities. Where Assets = Cash + Investments + Property + Gold + PF ; Liabilities = Loans + CC Dues. Debt-to-asset ratio below 30% indicates strong financial health. All calculations run entirely in your browser — no data is transmitted to any server.',
    faqs: [
  ...
  dividendyield: {
    ...
    howToSteps: [
      'Enter your Stock Price, Annual Dividend per Share, Number of Shares, and other required values in the input fields',
      'Results are computed instantly as you enter or modify values — no need to click a button',
      'Review the computed output showing your dividend yield results with a detailed breakdown',
      'Use the results to compare financial scenarios, plan budgets, or verify lender and investment calculations'
    ],
    methodology: 'This calculator uses the formula: Yield = (Annual Dividend / Stock Price) × 100. Where Payout Ratio = Dividend / EPS × 100 ; Annual Income = Dividend × Shares. Dividend yield shows annual return from dividends alone, independent of capital gains. All calculations run entirely in your browser — no data is transmitted to any server.',
    faqs: [
  ...
  goldinvestment: {
    ...
    howToSteps: [
      'Enter your Gold Quantity, Buy Price per 10g, Current Price per 10g, and other required values in the input fields',
      'Results are computed instantly as you enter or modify values — no need to click a button',
      'Review the computed output showing your gold investment results with a detailed breakdown',
      'Use the results to compare financial scenarios, plan budgets, or verify lender and investment calculations'
    ],
    methodology: 'This calculator uses the formula: Buy Cost = (Rate/10g) × Grams × (1 + Making%/100). Where Current Value = (Current Rate/10g) × Grams ; Profit = Current − Buy Cost. Making charges add to the purchase cost and reduce effective returns on gold jewelry. All calculations run entirely in your browser — no data is transmitted to any server.',
    faqs: [
  ...
  stockreturn: {
    ...
    howToSteps: [
      'Enter your Buy Price per Share, Sell Price per Share, Quantity of Shares, and other required values in the input fields',
      'Results are computed instantly as you enter or modify values — no need to click a button',
      'Review the computed output showing your stock return results with a detailed breakdown',
      'Use the results to compare financial scenarios, plan budgets, or verify lender and investment calculations'
    ],
    methodology: 'This calculator uses the formula: Net P&L = (Sell × Qty − Brokerage) − (Buy × Qty + Brokerage) − STT. Where STT = Securities Transaction Tax (0.1% both sides) ; Brokerage = per trade fee. Total return after accounting for brokerage on both legs and STT on turnover. All calculations run entirely in your browser — no data is transmitted to any server.',
    faqs: [
  ...
  mutualfundreturns: {
    ...
    howToSteps: [
      'Enter your Buy NAV, Current NAV, Units Held, and other required values in the input fields',
      'Results are computed instantly as you enter or modify values — no need to click a button',
      'Review the computed output showing your mutual fund returns results with a detailed breakdown',
      'Use the results to compare financial scenarios, plan budgets, or verify lender and investment calculations'
    ],
    methodology: 'This calculator uses the formula: CAGR = (Current NAV / Buy NAV)^(1/years) − 1. Where NAV = Net Asset Value ; Units = Number of fund units held. CAGR smooths out volatility to show annualized return over the holding period. All calculations run entirely in your browser — no data is transmitted to any server.',
    faqs: [
  ...
  balancetransfer: {
    ...
    howToSteps: [
      'Enter your Outstanding Principal, Current Interest Rate, New Bank Rate, and other required values in the input fields',
      'Results are computed instantly as you enter or modify values — no need to click a button',
      'Review the computed output showing your balance transfer results with a detailed breakdown',
      'Use the results to compare financial scenarios, plan budgets, or verify lender and investment calculations'
    ],
    methodology: 'This calculator uses the formula: Savings = Interest(Old Rate) − Interest(New Rate) − Processing Fee. Where Break-even = Processing Fee / Monthly Interest Difference. Transfer is beneficial only if net interest savings exceed the processing fee charged. All calculations run entirely in your browser — no data is transmitted to any server.',
    faqs: [
  ...
  scss: {
    ...
    howToSteps: [
      'Enter your Deposit Amount (max ₹30L), Interest Rate in the input fields provided',
      'Results are computed instantly as you enter or modify values — no need to click a button',
      'Review the computed output showing your senior citizen savings results with a detailed breakdown',
      'Use the results to compare financial scenarios, plan budgets, or verify lender and investment calculations'
    ],
    methodology: 'This calculator uses the formula: Quarterly Interest = Principal × Rate / 4 / 100. Where Principal = max ₹30L ; Tenure = 5 years ; Interest paid quarterly. SCSS pays quarterly interest (not compounded). Principal returned at maturity after 5 years. All calculations run entirely in your browser — no data is transmitted to any server.',
    faqs: [
  ...
  elssreturns: {
    ...
    howToSteps: [
      'Enter your Monthly SIP, Investment Period, Expected ELSS Return, and other required values in the input fields',
      'Results are computed instantly as you enter or modify values — no need to click a button',
      'Review the computed output showing your elss returns results with a detailed breakdown',
      'Use the results to compare financial scenarios, plan budgets, or verify lender and investment calculations'
    ],
    methodology: 'This calculator uses the formula: FV = SIP × ((1+r)ⁿ − 1) / r × (1+r) | Tax Saved = min(Investment, 1.5L) × Slab%. Where LTCG Tax = (Gains − 1.25L) × 12.5% ; Lock-in = 3 years. ELSS gives dual benefit — equity market returns plus Section 80C tax deduction. All calculations run entirely in your browser — no data is transmitted to any server.',
    faqs: [
  ...
  nsc: {
    ...
    howToSteps: [
      'Enter your Investment Amount, NSC Interest Rate, Tenure, and other required values in the input fields',
      'Results are computed instantly as you enter or modify values — no need to click a button',
      'Review the computed output showing your nsc results with a detailed breakdown',
      'Use the results to compare financial scenarios, plan budgets, or verify lender and investment calculations'
    ],
    methodology: 'This calculator uses the formula: Maturity = Principal × (1 + r)^n. Where r = NSC annual rate ; n = 5 years ; Interest compounded annually, paid at maturity. NSC interest is reinvested and also qualifies for 80C deduction (except last year). All calculations run entirely in your browser — no data is transmitted to any server.',
    faqs: [
  ...
  apy: {
    ...
    howToSteps: [
      'Enter your Current Age, Desired Monthly Pension in the input fields provided',
      'Results are computed instantly as you enter or modify values — no need to click a button',
      'Review the computed output showing your apy results with a detailed breakdown',
      'Use the results to compare financial scenarios, plan budgets, or verify lender and investment calculations'
    ],
    methodology: 'This calculator uses the formula: Contribution based on age and desired pension (government-fixed table). Where Pension options: ₹1K–₹5K/month ; Entry age: 18–40 ; Pension starts at 60. APY guarantees fixed monthly pension after 60. Spouse inherits pension, nominee gets corpus. All calculations run entirely in your browser — no data is transmitted to any server.',
    faqs: [
  ...
  brokerage: {
    ...
    howToSteps: [
      'Enter your Buy Price, Sell Price, Quantity, and other required values in the input fields',
      'Results are computed instantly as you enter or modify values — no need to click a button',
      'Review the computed output showing your brokerage results with a detailed breakdown',
      'Use the results to compare financial scenarios, plan budgets, or verify lender and investment calculations'
    ],
    methodology: 'This calculator uses the formula: Net P&L = (Sell − Buy) × Qty − Brokerage − STT − Exchange − GST − SEBI − Stamp. Where STT varies by trade type ; GST = 18% on (Brokerage + Exchange charges). Multiple charges eat into trading profits. Break-even price includes all transaction costs. All calculations run entirely in your browser — no data is transmitted to any server.',
    faqs: [
  ...
  salarycomparison: {
    ...
    howToSteps: [
      'Enter your Current CTC (Annual), New Offer CTC (Annual), Current Bonus %, and other required values in the input fields',
      'Results are computed instantly as you enter or modify values — no need to click a button',
      'Review the computed output showing your salary comparison results with a detailed breakdown',
      'Use the results to compare financial scenarios, plan budgets, or verify lender and investment calculations'
    ],
    methodology: 'This calculator uses the formula: CTC Hike % = (New CTC − Old CTC) / Old CTC × 100. Where Fixed Pay = CTC × (1 − Bonus%) − PF ; Monthly = Fixed / 12. Compare fixed monthly pay, not just CTC. Higher variable means less guaranteed salary. All calculations run entirely in your browser — no data is transmitted to any server.',
    faqs: [
  ...
  sgb: {
    ...
    howToSteps: [
      'Enter your Investment Amount, Issue Price per Gram, Expected Gold Price at Maturity (₹/gram), and other required values in the input fields',
      'Results are computed instantly as you enter or modify values — no need to click a button',
      'Review the computed output showing your sovereign gold bond (sgb) results with a detailed breakdown',
      'Use the results to compare financial scenarios, plan budgets, or verify lender and investment calculations'
    ],
    methodology: 'This calculator applies standard sovereign gold bond (sgb) formulas used across Indian banking and financial planning. Inputs are validated and processed using established mathematical models. Results include applicable rates and compounding where relevant. All processing happens locally in your browser — no financial data leaves your device.',
    faqs: [
  ...
  foTurnover: {
    ...
    howToSteps: [
      'Enter your Futures Total Profit, Futures Total Loss (absolute), Options Premium Received, and other required values in the input fields',
      'Results are computed instantly as you enter or modify values — no need to click a button',
      'Review the computed output showing your f&o turnover results with a detailed breakdown',
      'Use the results to compare financial scenarios, plan budgets, or verify lender and investment calculations'
    ],
    methodology: 'This calculator applies standard f&o turnover formulas used across Indian banking and financial planning. Inputs are validated and processed using established mathematical models. Results include applicable rates and compounding where relevant. All processing happens locally in your browser — no financial data leaves your device.',
    faqs: [
  ...
  presumptiveTax: {
    ...
    howToSteps: [
      'Enter your Taxpayer Type, Annual Turnover / Gross Receipts, Cash Receipts %, and other required values in the input fields',
      'Results are computed instantly as you enter or modify values — no need to click a button',
      'Review the computed output showing your presumptive tax calculator (44ad/44ada) results with a detailed breakdown',
      'Use the results to compare financial scenarios, plan budgets, or verify lender and investment calculations'
    ],
    methodology: 'This calculator applies standard presumptive tax calculator (44ad/44ada) formulas used across Indian banking and financial planning. Inputs are validated and processed using established mathematical models. Results include applicable rates and compounding where relevant. All processing happens locally in your browser — no financial data leaves your device.',
    faqs: [
  ...
  homeloanTaxBenefit: {
    ...
    howToSteps: [
      'Enter your Annual Interest Paid, Annual Principal Repaid, Annual Income, and other required values in the input fields',
      'Results are computed instantly as you enter or modify values — no need to click a button',
      'Review the computed output showing your home loan tax benefit results with a detailed breakdown',
      'Use the results to compare financial scenarios, plan budgets, or verify lender and investment calculations'
    ],
    methodology: 'This calculator applies standard home loan tax benefit formulas used across Indian banking and financial planning. Inputs are validated and processed using established mathematical models. Results include applicable rates and compounding where relevant. All processing happens locally in your browser — no financial data leaves your device.',
    faqs: [
  ...
  indexedCost: {
    ...
    howToSteps: [
      'Enter your Original Purchase Price, Sale Price, Purchase Year (FY), and other required values in the input fields',
      'Results are computed instantly as you enter or modify values — no need to click a button',
      'Review the computed output showing your indexed cost of acquisition results with a detailed breakdown',
      'Use the results to compare financial scenarios, plan budgets, or verify lender and investment calculations'
    ],
    methodology: 'This calculator applies standard indexed cost of acquisition formulas used across Indian banking and financial planning. Inputs are validated and processed using established mathematical models. Results include applicable rates and compounding where relevant. All processing happens locally in your browser — no financial data leaves your device.',
    faqs: [
  ...
  goldComparison: {
    ...
    howToSteps: [
      'Enter your Investment Amount, Investment Period, Expected Gold Price Growth, and other required values in the input fields',
      'Results are computed instantly as you enter or modify values — no need to click a button',
      'Review the computed output showing your digital gold vs sgb vs gold etf results with a detailed breakdown',
      'Use the results to compare financial scenarios, plan budgets, or verify lender and investment calculations'
    ],
    methodology: 'This calculator applies standard digital gold vs sgb vs gold etf formulas used across Indian banking and financial planning. Inputs are validated and processed using established mathematical models. Results include applicable rates and compounding where relevant. All processing happens locally in your browser — no financial data leaves your device.',
    faqs: [
  ...
  rentYield: {
    ...
    howToSteps: [
      'Enter your Property Value, Monthly Rent, Annual Maintenance, and other required values in the input fields',
      'Results are computed instantly as you enter or modify values — no need to click a button',
      'Review the computed output showing your rental yield results with a detailed breakdown',
      'Use the results to compare financial scenarios, plan budgets, or verify lender and investment calculations'
    ],
    methodology: 'This calculator applies standard rental yield formulas used across Indian banking and financial planning. Inputs are validated and processed using established mathematical models. Results include applicable rates and compounding where relevant. All processing happens locally in your browser — no financial data leaves your device.',
    faqs: [
