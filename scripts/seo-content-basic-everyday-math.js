...
module.exports = {
  ...
  freelancerate: {
    ...
    howToSteps: [
      'Enter the required values for your freelance rate calculation',
    ...
    methodology: 'This calculator uses straightforward mathematical formulas for the freelance rate computation. Calculations are based on standard rates, ratios, and conversion factors. Results are practical estimates suitable for everyday planning and decision-making.',
    faqs: [
  ...
  tipsplit: {
    ...
    howToSteps: [
      'Enter the required values for your tip split calculation',
      'Adjust any optional settings or preferences as needed',
      'View your results instantly — calculations update in real time',
      'Use the output for budgeting, comparison, or planning decisions'
    ],
    methodology: 'This calculator uses straightforward mathematical formulas for the tip split computation. Calculations are based on standard rates, ratios, and conversion factors. Results are practical estimates suitable for everyday planning and decision-making.',
    faqs: [
  ...
  evpetrolsavings: {
    ...
    howToSteps: [
      'Enter the required values for your ev vs petrol savings calculation',
      'Adjust any optional settings or preferences as needed',
      'View your results instantly — calculations update in real time',
      'Use the output for budgeting, comparison, or planning decisions'
    ],
    methodology: 'This calculator uses straightforward mathematical formulas for the ev vs petrol savings computation. Calculations are based on standard rates, ratios, and conversion factors. Results are practical estimates suitable for everyday planning and decision-making.',
    faqs: [
  ...
  weddingbudget: {
    ...
    howToSteps: [
      'Enter the required values for your wedding budget calculation',
      'Adjust any optional settings or preferences as needed',
      'View your results instantly — calculations update in real time',
      'Use the output for budgeting, comparison, or planning decisions'
    ],
    methodology: 'This calculator uses straightforward mathematical formulas for the wedding budget computation. Calculations are based on standard rates, ratios, and conversion factors. Results are practical estimates suitable for everyday planning and decision-making.',
    faqs: [
  ...
  rentafford: {
    ...
    howToSteps: [
      'Enter the required values for your rent affordability calculation',
      'Adjust any optional settings or preferences as needed',
      'View your results instantly — calculations update in real time',
      'Use the output for budgeting, comparison, or planning decisions'
    ],
    methodology: 'This calculator uses straightforward mathematical formulas for the rent affordability computation. Calculations are based on standard rates, ratios, and conversion factors. Results are practical estimates suitable for everyday planning and decision-making.',
    faqs: [
  ...
  travelbudget: {
    ...
    howToSteps: [
      'Enter the required values for your travel budget calculation',
      'Adjust any optional settings or preferences as needed',
      'View your results instantly — calculations update in real time',
      'Use the output for budgeting, comparison, or planning decisions'
    ],
    methodology: 'This calculator uses straightforward mathematical formulas for the travel budget computation. Calculations are based on standard rates, ratios, and conversion factors. Results are practical estimates suitable for everyday planning and decision-making.',
    faqs: [
  ...
  carbonfootprint: {
    ...
    howToSteps: [
      'Enter the required values for your carbon footprint calculation',
      'Adjust any optional settings or preferences as needed',
      'View your results instantly — calculations update in real time',
      'Use the output for budgeting, comparison, or planning decisions'
    ],
    methodology: 'This calculator uses straightforward mathematical formulas for the carbon footprint computation. Calculations are based on standard rates, ratios, and conversion factors. Results are practical estimates suitable for everyday planning and decision-making.',
    faqs: [
  ...
  ecomprofit: {
    ...
    howToSteps: [
      'Enter the required values for your e-commerce profit calculation',
      'Adjust any optional settings or preferences as needed',
      'View your results instantly — calculations update in real time',
      'Use the output for budgeting, comparison, or planning decisions'
    ],
    methodology: 'This calculator uses straightforward mathematical formulas for the e-commerce profit computation. Calculations are based on standard rates, ratios, and conversion factors. Results are practical estimates suitable for everyday planning and decision-making.',
    faqs: [
  ...
  restaurantcost: {
    ...
    howToSteps: [
      'Enter the required values for your restaurant cost calculation',
      'Adjust any optional settings or preferences as needed',
      'View your results instantly — calculations update in real time',
      'Use the output for budgeting, comparison, or planning decisions'
    ],
    methodology: 'This calculator uses straightforward mathematical formulas for the restaurant cost computation. Calculations are based on standard rates, ratios, and conversion factors. Results are practical estimates suitable for everyday planning and decision-making.',
    faqs: [
  ...
  subscriptionpricing: {
    ...
    howToSteps: [
      'Enter the required values for your subscription pricing calculation',
      'Adjust any optional settings or preferences as needed',
      'View your results instantly — calculations update in real time',
      'Use the output for budgeting, comparison, or planning decisions'
    ],
    methodology: 'This calculator uses straightforward mathematical formulas for the subscription pricing computation. Calculations are based on standard rates, ratios, and conversion factors. Results are practical estimates suitable for everyday planning and decision-making.',
    faqs: [
  ...
  uniteconomics: {
    ...
    howToSteps: [
      'Enter the required values for your unit economics calculation',
      'Adjust any optional settings or preferences as needed',
      'View your results instantly — calculations update in real time',
      'Use the output for budgeting, comparison, or planning decisions'
    ],
    methodology: 'This calculator uses straightforward mathematical formulas for the unit economics computation. Calculations are based on standard rates, ratios, and conversion factors. Results are practical estimates suitable for everyday planning and decision-making.',
    faqs: [
  ...
  eventbudget: {
    ...
    howToSteps: [
      'Enter the required values for your event budget calculation',
      'Adjust any optional settings or preferences as needed',
      'View your results instantly — calculations update in real time',
      'Use the output for budgeting, comparison, or planning decisions'
    ],
    methodology: 'This calculator uses straightforward mathematical formulas for the event budget computation. Calculations are based on standard rates, ratios, and conversion factors. Results are practical estimates suitable for everyday planning and decision-making.',
    faqs: [
  ...
  householdbudget: {
    ...
    howToSteps: [
      'Enter the required values for your household budget calculation',
      'Adjust any optional settings or preferences as needed',
      'View your results instantly — calculations update in real time',
      'Use the output for budgeting, comparison, or planning decisions'
    ],
    methodology: 'This calculator uses straightforward mathematical formulas for the household budget computation. Calculations are based on standard rates, ratios, and conversion factors. Results are practical estimates suitable for everyday planning and decision-making.',
    faqs: [
  ...
  laundry: {
    ...
    howToSteps: [
      'Enter the required values for your laundry calculation',
      'Adjust any optional settings or preferences as needed',
      'View your results instantly — calculations update in real time',
      'Use the output for budgeting, comparison, or planning decisions'
    ],
    methodology: 'This calculator uses straightforward mathematical formulas for the laundry computation. Calculations are based on standard rates, ratios, and conversion factors. Results are practical estimates suitable for everyday planning and decision-making.',
    faqs: [
  ...
  cooking: {
    ...
    howToSteps: [
      'Enter the required values for your cooking measurement conversion calculation',
      'Adjust any optional settings or preferences as needed',
      'View your results instantly — calculations update in real time',
      'Use the output for budgeting, comparison, or planning decisions'
    ],
    methodology: 'This calculator uses straightforward mathematical formulas for the cooking measurement conversion computation. Calculations are based on standard rates, ratios, and conversion factors. Results are practical estimates suitable for everyday planning and decision-making.',
    faqs: [
  ...
  shoesize: {
    ...
    howToSteps: [
      'Enter the required values for your shoe size conversion calculation',
      'Adjust any optional settings or preferences as needed',
      'View your results instantly — calculations update in real time',
      'Use the output for budgeting, comparison, or planning decisions'
    ],
    methodology: 'This calculator uses straightforward mathematical formulas for the shoe size conversion computation. Calculations are based on standard rates, ratios, and conversion factors. Results are practical estimates suitable for everyday planning and decision-making.',
    faqs: [
  ...
  petage: {
    ...
    howToSteps: [
      'Enter the required values for your pet age calculation',
      'Adjust any optional settings or preferences as needed',
      'View your results instantly — calculations update in real time',
      'Use the output for budgeting, comparison, or planning decisions'
    ],
    methodology: 'This calculator uses straightforward mathematical formulas for the pet age computation. Calculations are based on standard rates, ratios, and conversion factors. Results are practical estimates suitable for everyday planning and decision-making.',
    faqs: [
  ...
  stopwatch: {
    ...
    howToSteps: [
      'Enter the required values for your stopwatch calculation',
      'Adjust any optional settings or preferences as needed',
      'View your results instantly — calculations update in real time',
      'Use the output for budgeting, comparison, or planning decisions'
    ],
    methodology: 'This calculator uses straightforward mathematical formulas for the stopwatch computation. Calculations are based on standard rates, ratios, and conversion factors. Results are practical estimates suitable for everyday planning and decision-making.',
    faqs: [
  ...
  randomnum: {
    ...
    howToSteps: [
      'Enter the required values for your random number calculation',
      'Adjust any optional settings or preferences as needed',
      'View your results instantly — calculations update in real time',
      'Use the output for budgeting, comparison, or planning decisions'
    ],
    methodology: 'This calculator uses straightforward mathematical formulas for the random number generator computation. Calculations are based on standard rates, ratios, and conversion factors. Results are practical estimates suitable for everyday planning and decision-making.',
    faqs: [
  ...
  cartco: {
    ...
    howToSteps: [
      'Enter the required values for your shopping cart calculation',
      'Adjust any optional settings or preferences as needed',
      'View your results instantly — calculations update in real time',
      'Use the output for budgeting, comparison, or planning decisions'
    ],
    methodology: 'This calculator uses straightforward mathematical formulas for the shopping cart computation. Calculations are based on standard rates, ratios, and conversion factors. Results are practical estimates suitable for everyday planning and decision-making.',
    faqs: [
  ...
  wiresize: {
    ...
    howToSteps: [
      'Enter the required values for your wire size calculation',
      'Adjust any optional settings or preferences as needed',
      'View your results instantly — calculations update in real time',
      'Use the output for budgeting, comparison, or planning decisions'
    ],
    methodology: 'This calculator uses straightforward mathematical formulas for the wire size computation. Calculations are based on standard rates, ratios, and conversion factors. Results are practical estimates suitable for everyday planning and decision-making.',
    faqs: [
  ...
  pixelresolution: {
    ...
    howToSteps: [
      'Enter the required values for your pixel resolution calculation',
      'Adjust any optional settings or preferences as needed',
      'View your results instantly — calculations update in real time',
      'Use the output for budgeting, comparison, or planning decisions'
    ],
    methodology: 'This calculator uses straightforward mathematical formulas for the pixel resolution computation. Calculations are based on standard rates, ratios, and conversion factors. Results are practical estimates suitable for everyday planning and decision-making.',
    faqs: [
  ...
  quadratic: {
    ...
    methodology: 'This calculator implements standard mathematical formulas for quadratic equation solver operations. Computations follow established mathematical principles from standard textbooks. Results are precise to the level of JavaScript floating-point arithmetic.',
    faqs: [
  ...
  statistics: {
    ...
    methodology: 'This calculator implements standard mathematical formulas for statistics operations. Computations follow established mathematical principles from standard textbooks. Results are precise to the level of JavaScript floating-point arithmetic.',
    faqs: [
  ...
  lcmgcd: {
    ...
    methodology: 'This calculator implements standard mathematical formulas for lcm & gcd operations. Computations follow established mathematical principles from standard textbooks. Results are precise to the level of JavaScript floating-point arithmetic.',
    faqs: [
  ...
  fraction: {
    ...
    methodology: 'This calculator implements standard mathematical formulas for fraction operations. Computations follow established mathematical principles from standard textbooks. Results are precise to the level of JavaScript floating-point arithmetic.',
    faqs: [
  ...
  scientific: {
    ...
    methodology: 'This calculator implements standard mathematical formulas for scientific operations. Computations follow established mathematical principles from standard textbooks. Results are precise to the level of JavaScript floating-point arithmetic.',
    faqs: [
  ...
  matrix2x2: {
    ...
    methodology: 'This calculator implements standard mathematical formulas for 2×2 matrix operations. Computations follow established mathematical principles from standard textbooks. Results are precise to the level of JavaScript floating-point arithmetic.',
    faqs: [
  ...
  combinations: {
    ...
    methodology: 'This calculator implements standard mathematical formulas for combinations & permutations operations. Computations follow established mathematical principles from standard textbooks. Results are precise to the level of JavaScript floating-point arithmetic.',
    faqs: [
  ...
  stddev: {
    ...
    methodology: 'This calculator implements standard mathematical formulas for standard deviation operations. Computations follow established mathematical principles from standard textbooks. Results are precise to the level of JavaScript floating-point arithmetic.',
    faqs: [
  ...
  lineareq: {
    ...
    methodology: 'This calculator implements standard mathematical formulas for linear equation solver operations. Computations follow established mathematical principles from standard textbooks. Results are precise to the level of JavaScript floating-point arithmetic.',
    faqs: [
  ...
  determinant: {
    ...
    methodology: 'This calculator implements standard mathematical formulas for matrix determinant operations. Computations follow established mathematical principles from standard textbooks. Results are precise to the level of JavaScript floating-point arithmetic.',
    faqs: [
  ...
  complexnum: {
    ...
    methodology: 'This calculator implements standard mathematical formulas for complex number operations. Computations follow established mathematical principles from standard textbooks. Results are precise to the level of JavaScript floating-point arithmetic.',
    faqs: [
