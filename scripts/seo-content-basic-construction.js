...
module.exports = {
  ...
  stampdutycalc: {
    ...
    methodology: 'This calculator uses standard construction estimation methods based on IS codes and industry practices in India. The stamp duty estimation includes typical wastage factors and standard material ratios. Actual requirements may vary based on site conditions, material quality, and construction methods.',
    faqs: [
  ...
  constructioncost: {
    ...
    methodology: 'This calculator uses standard construction estimation methods based on IS codes and industry practices in India. The construction cost estimation includes typical wastage factors and standard material ratios. Actual requirements may vary based on site conditions, material quality, and construction methods.',
    faqs: [
  ...
  homerenovation: {
    ...
    methodology: 'This calculator uses standard construction estimation methods based on IS codes and industry practices in India. The home renovation estimation includes typical wastage factors and standard material ratios. Actual requirements may vary based on site conditions, material quality, and construction methods.',
    faqs: [
  ...
  concrete: {
    ...
    methodology: 'This calculator uses standard construction estimation methods based on IS codes and industry practices in India. The concrete estimation includes typical wastage factors and standard material ratios. Actual requirements may vary based on site conditions, material quality, and construction methods.',
    faqs: [
  ...
  bricks: {
    ...
    methodology: 'This calculator uses standard construction estimation methods based on IS codes and industry practices in India. The bricks estimation includes typical wastage factors and standard material ratios. Actual requirements may vary based on site conditions, material quality, and construction methods.',
    faqs: [
  ...
  paint: {
    ...
    methodology: 'This calculator uses standard construction estimation methods based on IS codes and industry practices in India. The paint estimation includes typical wastage factors and standard material ratios. Actual requirements may vary based on site conditions, material quality, and construction methods.',
    faqs: [
  ...
  flooring: {
    ...
    methodology: 'This calculator uses standard construction estimation methods based on IS codes and industry practices in India. The flooring estimation includes typical wastage factors and standard material ratios. Actual requirements may vary based on site conditions, material quality, and construction methods.',
    faqs: [
  ...
  steel: {
    ...
    methodology: 'This calculator uses standard construction estimation methods based on IS codes and industry practices in India. The steel estimation includes typical wastage factors and standard material ratios. Actual requirements may vary based on site conditions, material quality, and construction methods.',
    faqs: [
  ...
  roofing: {
    ...
    methodology: 'This calculator uses standard construction estimation methods based on IS codes and industry practices in India. The roofing estimation includes typical wastage factors and standard material ratios. Actual requirements may vary based on site conditions, material quality, and construction methods.',
    faqs: [
  ...
  landarea: {
    ...
    methodology: 'This calculator uses standard construction estimation methods based on IS codes and industry practices in India. The land area estimation includes typical wastage factors and standard material ratios. Actual requirements may vary based on site conditions, material quality, and construction methods.',
    faqs: [
  ...
  solarpanel: {
    ...
    methodology: 'This calculator uses standard construction estimation methods based on IS codes and industry practices in India. The solar panel estimation includes typical wastage factors and standard material ratios. Actual requirements may vary based on site conditions, material quality, and construction methods.',
    faqs: [
  ...
  concretemix: {
    ...
    methodology: 'This calculator uses standard construction estimation methods based on IS codes and industry practices in India. The concrete mix estimation includes typical wastage factors and standard material ratios. Actual requirements may vary based on site conditions, material quality, and construction methods.',
    faqs: [
  ...
  materialwaste: {
    ...
    methodology: 'This calculator uses standard construction estimation methods based on IS codes and industry practices in India. The material waste estimation includes typical wastage factors and standard material ratios. Actual requirements may vary based on site conditions, material quality, and construction methods.',
    faqs: [
  ...
  rainwater: {
    ...
    methodology: 'This calculator uses standard construction estimation methods based on IS codes and industry practices in India. The rainwater harvesting estimation includes typical wastage factors and standard material ratios. Actual requirements may vary based on site conditions, material quality, and construction methods.',
    faqs: [
  ...
  earthwork: {
    ...
    methodology: 'This calculator uses standard construction estimation methods based on IS codes and industry practices in India. The earthwork estimation includes typical wastage factors and standard material ratios. Actual requirements may vary based on site conditions, material quality, and construction methods.',
    faqs: [
  ...
  plasterwork: {
    ...
    methodology: 'This calculator uses standard construction estimation methods based on IS codes and industry practices in India. The plasterwork estimation includes typical wastage factors and standard material ratios. Actual requirements may vary based on site conditions, material quality, and construction methods.',
    faqs: [
  ...
  dateiff: {
    ...
    methodology: 'This calculator uses the Gregorian calendar system with correct handling of leap years, varying month lengths, and day-of-week algorithms. The date difference computation accounts for calendar edge cases. Timezone calculations reference the IANA Time Zone Database.',
    faqs: [
  ...
  workingdays: {
    ...
    methodology: 'This calculator uses the Gregorian calendar system with correct handling of leap years, varying month lengths, and day-of-week algorithms. The working days computation accounts for calendar edge cases. Timezone calculations reference the IANA Time Zone Database.',
    faqs: [
  ...
  timeconv: {
    ...
    methodology: 'This calculator uses the Gregorian calendar system with correct handling of leap years, varying month lengths, and day-of-week algorithms. The time converter computation accounts for calendar edge cases. Timezone calculations reference the IANA Time Zone Database.',
    faqs: [
  ...
  countdown: {
    ...
    methodology: 'This calculator uses the Gregorian calendar system with correct handling of leap years, varying month lengths, and day-of-week algorithms. The countdown computation accounts for calendar edge cases. Timezone calculations reference the IANA Time Zone Database.',
    faqs: [
  ...
  eduloan: {
    ...
    howToSteps: [
      ...
      'Results are computed automatically — review your calculated education loan output',
      'Use the results for academic planning, exam preparation, or performance tracking'
    ],
    methodology: 'This calculator implements standard academic formulas used by universities and examination boards. The education loan calculation follows grading policies from UGC, CBSE, and international standards. Results should be verified against your specific institution\'s policies.',
    faqs: [
  ...
  examneeded: {
    ...
    howToSteps: [
      'Enter your academic data such as grades, marks, credits, or study parameters',
      'Select your grading scale or institution type if prompted',
      'Results are computed automatically — review your calculated exam score output',
      'Use the results for academic planning, exam preparation, or performance tracking'
    ],
    methodology: 'This calculator implements standard academic formulas used by universities and examination boards. The exam score calculation follows grading policies from UGC, CBSE, and international standards. Results should be verified against your specific institution\'s policies.',
    faqs: [
