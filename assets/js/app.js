...
function openCalc(catKey, calcId) {
    ...
    document.getElementById('mainContent').innerHTML =
        ...
        +'<span class="trust-item"><i class="fas fa-lock"></i>No data collected</span>'
...
function buildCalcFAQ(calcId, calc) {
    ...
    if (!faqs.length) {
        ...
        faqs.push({ q: 'Is this calculator free?', a: 'Yes, 100% free forever. No signup, no ads, no data collection. Calc Labz works offline as a PWA — install it for instant access anytime.' });
    }
...
function showAboutPage() {
    ...
    document.getElementById('mainContent').innerHTML =
        ...
        + '<p class="about-lead">Calc Labz is a <strong>free, ad-free, no-signup</strong> calculator suite built for students, professionals, and everyday users across India and the world. With <strong>300+ tools</strong> spanning Finance, Health, Math, Education, Engineering and more — everything you need is one click away.</p>'
        + '</div>'
        ...
        + '<div class="about-card"><div class="about-icon" style="background:linear-gradient(135deg,#10b981,#34d399)"><i class="fas fa-lock"></i></div><h3>Zero Data Collection</h3><p>We collect absolutely nothing. No cookies, no analytics, no login. Your numbers stay on your device.</p></div>'
...
function showPrivacyPage() {
    ...
    setMeta('description', 'Calc Labz Privacy Policy — we collect no personal data, no cookies, and no analytics. Your calculations stay entirely on your device.');
    ...
    document.getElementById('mainContent').innerHTML =
        ...
        + '<div class="legal-notice"><i class="fas fa-shield-halved"></i><strong>Short version:</strong> Calc Labz collects <em>zero</em> personal data. No cookies. No analytics. No login. Everything stays on your device.</div>'
        ...
        + '<h2>2. Cookies</h2>'
        + '<p>Calc Labz uses <strong>no cookies</strong> of any kind — no session cookies, no tracking cookies, and no third-party advertising cookies.</p>'

        + '<h2>3. Analytics & Third-Party Services</h2>'
        + '<p>We do not use Google Analytics, Facebook Pixel, or any other analytics platform. No third-party scripts monitor your behavior on this site.</p>'
        + '<p>We do load the following resources from CDNs for performance:</p>'
        + '<ul><li><strong>Google Fonts</strong> (Inter typeface) — your browser may log a request to fonts.googleapis.com. Google\'s Privacy Policy governs that request.</li>'
        + '<li><strong>Font Awesome</strong> (icons) — loaded from cdnjs.cloudflare.com. Cloudflare\'s Privacy Policy governs that request.</li>'
        + '<li><strong>Chart.js</strong> (charts) — loaded on-demand from cdn.jsdelivr.net. jsDelivr\'s Privacy Policy governs that request.</li></ul>'
        ...
        + '<p>Calc Labz does not knowingly collect data from children under 13. Since we collect no data at all, we comply fully with COPPA and DPDPA guidelines.</p>'

        + '<h2>7. Changes to This Policy</h2>'
        + '<p>We may update this policy if we add new features. Any changes will be reflected on this page with an updated date. We will never introduce data collection without explicit user consent.</p>'

        + '<h2>8. Contact</h2>'
        + '<p>Questions about privacy? We\'re committed to transparency. You can reach us through the Calc Labz website. Since we store no data, there\'s nothing to request deletion of!</p>'
